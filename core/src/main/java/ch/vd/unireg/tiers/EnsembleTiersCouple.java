...
public class EnsembleTiersCouple {
	 ...
	 *
	 * @param principal le tiers principal
	 */
	 ...
	 *
	 * @param conjoint le tiers secondaire
	 */
	...
	/**
	 * Test que le tiers menage soit rattaché au deux tiers donnés. Si un seul des tiers est renseigné en entré et que l'ensembleTiersCouple est composé de deux, on doit retourner faux. Pour tester la
	 * presence d'un tiers dans un ensemble tiers couple, utiliser la méthode {@link #contient(PersonnePhysique)}
	 *
	 * @param tiers      le premier tiers composant le menage
	 * @param autreTiers l'autre tiers composant le menage
	 ...
	 *
	 * @param tiers le tiers dont on veut le conjoint
	...
	/**
	 * Determine si un tiers appartient à un ensemble tiers couple
	 *
