...
import static ch.vd.unireg.type.TypeEvenementEntreprise.Source.FOSC;
import static ch.vd.unireg.type.TypeEvenementEntreprise.Source.IDE;
import static ch.vd.unireg.type.TypeEvenementEntreprise.Source.RCENT;
import static ch.vd.unireg.type.TypeEvenementEntreprise.Source.RCPERS;
import static ch.vd.unireg.type.TypeEvenementEntreprise.Source.REE;
 ...
 * @since 6.x
 */
public enum TypeEvenementEntreprise {
	...
	/**
	 * La source d'un énévenement entreprise, c'est à dire son émetteur original.
	 */
	public enum Source {
	...
	/**
	 * Si ce flag est levé, alors l'événement entreprise doit être complètement ignoré
	 */
	 ...
	 */
	private static final Map<Integer, TypeEvenementEntreprise> typesByCode;

	static {
		typesByCode = new HashMap<>();
		for (TypeEvenementEntreprise type : TypeEvenementEntreprise.values()) {
	 ...
	 */
	TypeEvenementEntreprise(int i, String description, Source source) {
	 ...
	 * @param i   code identifiant le type d'événement
	 * @param description description du type d'événement
	 * @param ignore vrai si un événement entreprise de ce type doit être complètement ignoré
	 */
	TypeEvenementEntreprise(int i, String description, Source source, boolean ignore) {
		this.id = i;
	 ...
	 */
	public static TypeEvenementEntreprise valueOf(int code) {
