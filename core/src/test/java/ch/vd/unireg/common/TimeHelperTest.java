...
public class TimeHelperTest extends WithoutSpringTest {
	...
	public void testFormatDuree() {
		...
		assertEquals("0 seconde", TimeHelper.formatDuree(Duration.ofMillis(500)));
		assertEquals("1 seconde", TimeHelper.formatDuree(0, 0, 0, 1));
		assertEquals("2 secondes", TimeHelper.formatDuree(0, 0, 0, 2));
		assertEquals("2 secondes", TimeHelper.formatDuree(Duration.ofSeconds(2)));

		assertEquals("1 minute", TimeHelper.formatDuree(0, 0, 1, 0));
		assertEquals("1 minute", TimeHelper.formatDuree(Duration.ofSeconds(60)));
		assertEquals("2 minutes", TimeHelper.formatDuree(0, 0, 2, 0));
		assertEquals("2 minutes", TimeHelper.formatDuree(Duration.ofSeconds(120)));

		assertEquals("1 heure et 2 minutes", TimeHelper.formatDuree(0, 1, 2, 0));
		assertEquals("1 heure et 2 minutes", TimeHelper.formatDuree(Duration.ofMinutes(62)));
		assertEquals("2 heures et 10 secondes", TimeHelper.formatDuree(0, 2, 0, 10));
		assertEquals("2 heures et 10 secondes", TimeHelper.formatDuree(Duration.ofSeconds(7210)));
	...
	public void testFormatDureeShort() {
		...
		assertEquals("0s", TimeHelper.formatDureeShort(Duration.ofMillis(500)));
		assertEquals("1s", TimeHelper.formatDureeShort(0, 0, 0, 1));
		assertEquals("2s", TimeHelper.formatDureeShort(0, 0, 0, 2));
		assertEquals("2s", TimeHelper.formatDureeShort(Duration.ofSeconds(2)));

		assertEquals("1m 00s", TimeHelper.formatDureeShort(0, 0, 1, 0));
		assertEquals("1m 00s", TimeHelper.formatDureeShort(Duration.ofSeconds(60)));
		assertEquals("2m 00s", TimeHelper.formatDureeShort(0, 0, 2, 0));
		assertEquals("2m 00s", TimeHelper.formatDureeShort(Duration.ofMinutes(2)));

		assertEquals("1h 02m 00s", TimeHelper.formatDureeShort(0, 1, 2, 0));
		assertEquals("1h 02m 00s", TimeHelper.formatDureeShort(Duration.ofMinutes(62)));
		assertEquals("2h 00m 10s", TimeHelper.formatDureeShort(0, 2, 0, 10));
		assertEquals("2h 00m 10s", TimeHelper.formatDureeShort(Duration.ofSeconds(7210)));
	...
	public void testFormatDureeArrondie() {
		...
		assertEquals("0 seconde", TimeHelper.formatDureeArrondie(Duration.ofMillis(500)));
		...
		assertEquals("2 heures", TimeHelper.formatDureeArrondie(Duration.ofSeconds(7210)));                                // 2 heures et 10 secondes
