...
public class StandardBatchIteratorTest extends WithoutSpringTest {
	...
	public void testEmptyIterator() {
		...
		StandardBatchIterator<Object> iter = new StandardBatchIterator<>(empty, 100);
	...
	public void testZeroBatchSize() {
		try {
			new StandardBatchIterator<>(Collections.<Object> emptyList(), 0);
			fail();
		}
	...
	public void testOneBatch() {
		...
		StandardBatchIterator<Integer> iter = new StandardBatchIterator<>(list, 100);
	...
	public void testThreeBatches() {
		...
		StandardBatchIterator<Integer> iter = new StandardBatchIterator<>(list, 2);
