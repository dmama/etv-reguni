...
public class AdressePermanenteLoggedElement implements LoggedElement {
	...
	private static final List<LoggedElementAttribute> NAMES = Collections.unmodifiableList(Arrays.asList(LoggedElementAttribute.ADRESSE_DATE_DEBUT,
	                                                                                                     ...
	                                                                                                     LoggedElementAttribute.ADRESSE_USAGE,
	...
	public AdressePermanenteLoggedElement(AdresseGenerique adresse, TypeAdresseTiers usage) {
		this.values = buildItemValues(adresse, usage);
	}

	@NotNull
	private static Map<LoggedElementAttribute, Object> buildItemValues(AdresseGenerique adresse, TypeAdresseTiers usage) {
		...
		LoggedElementHelper.addValue(map, LoggedElementAttribute.ADRESSE_USAGE, usage);
