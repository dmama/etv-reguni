...
public class LongAsFixedCharUserType extends GenericUserType implements UserType, ParameterizedType {
	...
	public Long nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
		...
		return strValue != null ? Long.valueOf(strValue) : null;
	}
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session) throws HibernateException, SQLException {
		...
		if (value == null) {
			...
			st.setString(index, String.format(formatString, (Long) value));
		}
	}
}
