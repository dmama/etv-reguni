...
public class NexusTomcatRunner {
	...
	// private static final Logger log = LoggerFactory.getLogger(NexusTomcatRunner.class);
	...
	public static void main(String[] args) throws Exception {
		...
		// BEGIN_LVERSION
		System.setProperty("project.version", "19R3.A.0-SNAPSHOT");
		// END_LVERSION
		...
		System.setProperty("unireg-nexus.log4j.location", "file:${ch.vd.appDir}/${unireg-nexus.appname}/config/unireg-log4j2.xml");
