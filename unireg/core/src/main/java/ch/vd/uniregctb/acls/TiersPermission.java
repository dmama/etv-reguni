...
public final class TiersPermission implements Permission {
	 ...
	 */
	public static final Permission CREATE = new TiersPermission(1, 'C'); // 1

	/**
	 * Autorisé à lire le tiers.
	 */
	public static final Permission READ = new TiersPermission(1 << 1, 'R'); // 2

	/**
	 * Autorisé à modifier le tiers.
	 */
	public static final Permission UPDATE = new TiersPermission(1 << 2, 'U'); // 4

	/**
	 * Autorisé à supprimer le tiers.
	 */
	public static final Permission DELETE = new TiersPermission(1 << 3, 'D'); // 8
