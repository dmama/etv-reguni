 ...
 *
 */
public interface EvenementCivilExterneDAO extends GenericDAO<EvenementCivilExterne, Long> {
	 ...
	 */
	List<EvenementCivilExterne> rechercheEvenementExistantEtTraitable(RegDate dateEvenement, TypeEvenementCivil typeEvenement, Long noIndividu );
	 ...
	 * @return
	 */
	List<EvenementCivilExterne> find(EvenementCivilExterneCriteria criterion, ParamPagination paramPagination);

	/**
	 * @param criterion
	 * @return
	 */
	int count(EvenementCivilExterneCriteria criterion);
	 ...
	 * @return une liste d'ids des événements civils
	 */
	List<EvenementCivilExterne> getEvenementsCivilsNonTraites(Collection<Long> nosIndividus);
