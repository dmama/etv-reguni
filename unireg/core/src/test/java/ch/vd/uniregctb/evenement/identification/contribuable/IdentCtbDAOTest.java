...
public class IdentCtbDAOTest extends CoreDAOTest {
	...
	public void testFind() throws Exception {
		...
		identificationContribuableCriteria.setEmetteurId(new String("Test"));
		identificationContribuableCriteria.setEtatMessage(new String("EXCEPTION"));
		identificationContribuableCriteria.setNAVS13(new String("1234567890123"));
		identificationContribuableCriteria.setNom(new String("Larousse"));
		identificationContribuableCriteria.setPeriodeFiscale(Integer.valueOf(2008));
		identificationContribuableCriteria.setPrenoms(new String("Lora"));
		identificationContribuableCriteria.setPrioriteEmetteur(new String("NON_PRIORITAIRE"));
