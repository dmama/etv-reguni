...
public class Ec_4000_01_Mariage_CoupleArriveHorsSuisse_Scenario extends EvenementCivilScenario {
	...
	protected void initServiceCivil() {
		serviceCivilService.setUp(new MockServiceCivil(infraService) {
			...
			protected void init() {
				...
				addPermis(indRafa, TypePermis.ETABLISSEMENT, RegDate.get(2008, 10, 1), null, 0, false);
	...
	public void check2() throws Exception {
		...
		final List<EvenementCivilExterne> evts = getEvenementsCivils(noIndRafa, TypeEvenementCivil.MARIAGE);
		...
		for (EvenementCivilExterneErreur erreur : evt.getErreurs()) {
