...
public class Ec_19000_08_Depart_JIRA1996_Scenario extends DepartScenario {
	...
	protected void initServiceCivil() {
		serviceCivilService.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				addAdresse(indCharles, EnumTypeAdresse.PRINCIPALE, MockRue.Chamblon.GrandRue, null, MockLocalite.Chamblon, dateAmenagement, null);
				addAdresse(indCharles, EnumTypeAdresse.COURRIER,  MockRue.Chamblon.GrandRue, null, MockLocalite.Chamblon, dateAmenagement, null);
	...
	public void etape1() throws Exception {
		...
		final MenageCommun menage = (MenageCommun) tiersDAO.save(new MenageCommun());
		{
			...
			addForFiscalPrincipal(menage, communeDepart.getNoOFS(), dateDebutForChamblon, null, MotifFor.DEMENAGEMENT_VD, null);
		}
	}
	...
	public void check1() throws Exception {
...

		{
			...
			assertEquals(communeDepart.getNomMinuscule(),
					serviceCivilService.getAdresses(noIndCharles, RegDate.get()).principale.getLocalite(),
	...
	public void check2() throws Exception {
...

		{
			...
			assertEquals(MockLocalite.Enney.getNomCompletMinuscule(),
					serviceCivilService.getAdresses(noIndCharles, dateArrivee).principale.getLocalite(),
					"L'adresse principale n'est pas à Enney");
			assertEquals(MockLocalite.Enney.getNomCompletMinuscule(),
					serviceCivilService.getAdresses(noIndGeorgette, dateArrivee).principale.getLocalite(),
			"L'adresse principale n'est pas à Enney");
		}
