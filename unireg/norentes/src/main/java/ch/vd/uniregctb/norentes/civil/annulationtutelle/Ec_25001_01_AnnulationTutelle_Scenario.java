...
public class Ec_25001_01_AnnulationTutelle_Scenario extends EvenementCivilScenario {
	...
	public static final String NAME = "25001_01_AnnulationTutelle";

	@Override
	public TypeEvenementCivil geTypeEvenementCivil() {
		return TypeEvenementCivil.ANNUL_MESURE_TUTELLE;
	}

	@Override
	public String getDescription() {
		return "Annulation de mesure de tutelle";
	}
	...
	public void check1() {
		{
			...
			assertNull(rapportTutelle.getDateFin(), "Le rapport tutelle est déjà fermé");
		}
		{
	...
	public void step2() throws Exception {
		long id = addEvenementCivil(TypeEvenementCivil.ANNUL_MESURE_TUTELLE, noIndMomo, dateTutelle, commune.getNoOFS());
	...
	public void check2() {
		{
			...
			assertEquals(1, nombreRapportsTutelle, "Aucun rapport de tutelle (ou plus d'un) a été trouvé");
			assertEquals(true, rapportTutelle.isAnnule(), "Le rapport tutelle n'a pas été annulé");
		}
		{
			PersonnePhysique pierre = (PersonnePhysique) tiersDAO.get(noHabPierre);
			Set<RapportEntreTiers> rapportsEntreTiers = pierre.getRapportsObjet();
