...
public class Ec_19000_06_Depart_JIRA771_Scenario extends DepartScenario {
	...
	public void check2() throws Exception {
		...
		
		{
			...
			assertEquals(communeArrivee.getNomMinuscule(), 
					serviceCivilService.getAdresses(noIndSebastien, dateDepart.addDays(1)).principale.getLocalite(), 
	...
	private void assertAdressesFiscales(Tiers tiers, MockCommune commune) throws AdressesResolutionException {
		final AdressesFiscales adresses = adresseService.getAdressesFiscales(tiers, null);
