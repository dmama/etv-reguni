...
public class Ec_19000_03_Depart_HS_Scenario extends DepartScenario {
	...
	private final InternalServiceCivil internalServiceCivil = new InternalServiceCivil();
	...
	public void check1() throws Exception {

		{
			...
			assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndCedric, dateArriveeBex).principale.getLocalite(), "L'adresse principale n'est pas à Bex");
		}

		{
			...
			// vérification que les adresses civiles sont a Bex
			assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndSandra, dateArriveeBex).principale.getLocalite(), "L'adresse principale n'est pas à Bex");
		}
	...
	public void check2() throws Exception {

		{
			...
			assertEquals(numOfsPaysDepart, serviceCivilService.getAdresses(noIndCedric, dateDepartBex.addDays(1)).principale.getNoOfsPays(), "L'adresse principale n'est pas fermée");
		}

		{
			...
			assertEquals(numOfsPaysDepart, serviceCivilService.getAdresses(noIndSandra, dateDepartBex.addDays(1)).principale.getNoOfsPays(), "L'adresse principale n'est pas fermée");
		}
