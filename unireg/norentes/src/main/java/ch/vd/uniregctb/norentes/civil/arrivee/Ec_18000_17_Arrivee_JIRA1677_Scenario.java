...
public class Ec_18000_17_Arrivee_JIRA1677_Scenario extends EvenementCivilScenario {
	...
	public void check2() throws Exception {
		...
		final PersonnePhysique antonio = tiersService.getPersonnePhysiqueByNumeroIndividu(noIndOlivier);
		assertNotNull(antonio, "L'habitant Antonio n'a pas été créé ?");

		final PersonnePhysique anneLaure = tiersService.getPersonnePhysiqueByNumeroIndividu(noIndAlexandra);
