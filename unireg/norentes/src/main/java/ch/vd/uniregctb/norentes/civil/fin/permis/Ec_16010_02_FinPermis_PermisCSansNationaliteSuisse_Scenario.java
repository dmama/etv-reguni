...
public class Ec_16010_02_FinPermis_PermisCSansNationaliteSuisse_Scenario extends EvenementCivilScenario {
	...
	private final class MyMockServiceCivil extends DefaultMockServiceCivil {
		...
		protected void init() {
			...
			addPermis(rosa, EnumTypePermis.COURTE_DUREE, dateArrivee, dateObtentionPermisC.getOneDayBefore(), 0, false);
			addPermis(rosa, EnumTypePermis.ETABLLISSEMENT, dateObtentionPermisC, null, 1, false);
		}
	...
	public void step1() {
		...
		ForFiscalPrincipal f = addForFiscalPrincipal(rosa, communePermis, dateArrivee, dateObtentionPermisC.getOneDayBefore(),
	...
	public void step2() throws Exception {
		...
		long id = addEvenementCivil(TypeEvenementCivil.FIN_CHANGEMENT_CATEGORIE_ETRANGER, noIndRosa, dateFinPermisC, communePermis);
