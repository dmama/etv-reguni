...
public class Ec_19000_01_Depart_1_Scenario extends EvenementCivilScenario {
	...
	public void check1() throws Exception {
		...
		assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndAlain, dateArriveeBex).principale.getLocalite(),
	...
	public void check2() throws Exception {
		...
		assertEquals(MockCommune.Zurich.getNomMinuscule(), serviceCivilService.getAdresses(noIndAlain, dateArriveeZurich).principale.getLocalite(),
	...
	private void addAdresseZurich(MockIndividu ind) {
		...
		Adresse aa = MockServiceCivil.newAdresse(EnumTypeAdresse.PRINCIPALE, MockRue.Zurich.GloriaStrasse, null, MockLocalite.Zurich, dateArriveeZurich, null);
		adrs.add(aa);
	}
