...
public class Ec_19000_06_Depart_JIRA1286_Scenario extends DepartScenario {
	...
	public void check1() {
		...
		assertEquals(communeDepart.getNomMinuscule(), 
				serviceCivilService.getAdresses(noIndIan, RegDate.get()).principale.getLocalite(), 
	...
	public void check2() throws Exception {
		...
		assertEquals(paysArrivee.getNoOFS(), 
				serviceCivilService.getAdresses(noIndIan, dateDepart.addDays(1)).principale.getNoOfsPays(), 
