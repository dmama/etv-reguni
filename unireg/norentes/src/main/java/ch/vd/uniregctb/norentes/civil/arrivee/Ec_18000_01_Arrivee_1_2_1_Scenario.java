...
public class Ec_18000_01_Arrivee_1_2_1_Scenario extends EvenementCivilScenario {
	...
	public void check1() throws Exception {
		...
		assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndAlain, dateDepartBex).principale.getLocalite(),
				"l'adresse principale n'est pas à Bex");
		assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndJanine, dateDepartBex).principale.getLocalite(),
			"l'adresse principale n'est pas à Bex");
		assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndFanny, dateDepartBex).principale.getLocalite(),
			"l'adresse principale n'est pas à Bex");
		assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndJulien, dateDepartBex).principale.getLocalite(),
			"l'adresse principale n'est pas à Bex");
	}
	...
	public void check2() throws Exception {
		...
		assertEquals(MockCommune.Orbe.getNomMinuscule(), serviceCivilService.getAdresses(noIndAlain, dateArriveeOrbe).principale.getLocalite(),
			"l'adresse principale n'est pas à Orbe");
		assertEquals(MockCommune.Orbe.getNomMinuscule(), serviceCivilService.getAdresses(noIndJanine, dateArriveeOrbe).principale.getLocalite(),
			"l'adresse principale n'est pas à Orbe");
		assertEquals(MockCommune.Orbe.getNomMinuscule(), serviceCivilService.getAdresses(noIndFanny, dateArriveeOrbe).principale.getLocalite(),
			"l'adresse principale n'est pas à Orbe");
		assertEquals(MockCommune.Orbe.getNomMinuscule(), serviceCivilService.getAdresses(noIndJulien, dateArriveeOrbe).principale.getLocalite(),
			"l'adresse principale n'est pas à Orbe");
	}
