...
public class Ec_4000_04_Mariage_CoupleArriveHorsSuisseEnDeuxFois_Scenario extends MariageApresArriveeScenarios {
	...
	private class InternalServiceCivil extends MockServiceCivil {
		...
		protected void init() {
			...
			addPermis(indRafa, TypePermis.ETABLISSEMENT, RegDate.get(2005, 10, 1), null, 0, false);
			...
			addPermis(indMaria, TypePermis.ETABLISSEMENT, RegDate.get(2005, 12, 1), null, 0, false);
	...
	public void check3() throws Exception {
		...
		final EvenementCivilData evt = getEvenementCivilRegoupeForHabitant(noHabMaria);
