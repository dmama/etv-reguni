...
public class Ec_18000_02_Arrivee_HC_1_Scenario extends EvenementCivilScenario {
	...
	public void check1() throws Exception {
		...
		assertEquals(MockCommune.Bex.getNomMinuscule(), serviceCivilService.getAdresses(noIndAntoine, dateArriveeBex).principale.getLocalite(),
...
/*	private void addAdresseBex(MockIndividu ind) {
		...
		Adresse aa = MockServiceCivil.newAdresse(EnumTypeAdresse.PRINCIPALE, MockRue.Bex.RouteDuBoet, null, MockLocalite.Bex,
				dateArriveeBex, null);
		adrs.add(aa);
	}*/
