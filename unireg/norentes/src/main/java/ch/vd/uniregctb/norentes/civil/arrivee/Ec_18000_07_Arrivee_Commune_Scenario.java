...
public class Ec_18000_07_Arrivee_Commune_Scenario extends EvenementCivilScenario {
	...
	public void check1() throws Exception {
		...
		assertEquals(communeDepart.getNomMinuscule(), serviceCivilService.getAdresses(noIndAdrienne, null).principale.getLocalite(),
	...
	public void check2() throws Exception {
		...
		assertEquals(communeDepart.getNoOFS(), ffp.getNumeroOfsAutoriteFiscale(), "le for principal n'est pas sur " + communeDepart.getNomMinuscule());
		assertEquals(communeArrivee.getNomMinuscule(), serviceCivilService.getAdresses(noIndAdrienne, null).principale.getLocalite(),
