...
import ch.vd.uniregctb.webservices.tiers2.CodeQuittancement;
import ch.vd.uniregctb.webservices.tiers2.Date;
import ch.vd.uniregctb.webservices.tiers2.Declaration;
import ch.vd.uniregctb.webservices.tiers2.DeclarationImpotOrdinaire;
import ch.vd.uniregctb.webservices.tiers2.DeclarationImpotOrdinaireKey;
import ch.vd.uniregctb.webservices.tiers2.DemandeQuittancementDeclaration;
import ch.vd.uniregctb.webservices.tiers2.EtatDeclaration;
import ch.vd.uniregctb.webservices.tiers2.GetTiersHisto;
import ch.vd.uniregctb.webservices.tiers2.QuittancerDeclarations;
import ch.vd.uniregctb.webservices.tiers2.ReponseQuittancementDeclaration;
import ch.vd.uniregctb.webservices.tiers2.ReponseQuittancementDeclarationArray;
import ch.vd.uniregctb.webservices.tiers2.TiersHisto;
import ch.vd.uniregctb.webservices.tiers2.TiersPart;
import ch.vd.uniregctb.webservices.tiers2.TypeEtatDeclaration;
import ch.vd.uniregctb.webservices.tiers2.UserLogin;
import ch.vd.uniregctb.webservices.tiers2.WebServiceExceptionType;
...
public class TiersServiceWebCEDITest extends AbstractTiersServiceWebTest {
	...
	public void testQuittancerDeclarationContribuableInconnu() throws Exception {
		...
		QuittancerDeclarations params = new QuittancerDeclarations();
		...
		final ReponseQuittancementDeclarationArray array = service.quittancerDeclarations(params);
		assertNotNull(array);
		...
		assertEquals(CodeQuittancement.EXCEPTION, reponse.getCode());
		assertEquals(WebServiceExceptionType.BUSINESS, reponse.getExceptionType());
	...
	public void testQuittancerPlusieursDeclarations() throws Exception {
		...
		assertEquals(CodeQuittancement.EXCEPTION, reponse0.getCode());
		assertEquals(WebServiceExceptionType.BUSINESS, reponse0.getExceptionType());
	...
	private void assertQuittancement(Date dateObtention, long ctbID, int periodeFiscale, int numeroSequenceDI) throws Exception {
		...
		for (Declaration d : declarations) {
			...
			if (di.getPeriodesFiscale().getAnnee() == periodeFiscale && di.getNumero() == numeroSequenceDI) {
				declaration = di;
				break;
			}
		}
