 ...
 *
 */
package ch.vd.uniregctb.selenium;
...
public class XlateHtmlSeleneseToJava {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Iterator<String> it = inputFileList.keySet().iterator(); it.hasNext();) {
            String s = it.next();
            if (FILE.equals(inputFileList.get(s))) {
                ...
                for (int k = 0; k < children.length; k++) {
                    ...
                    else if (fileName.indexOf(".html")!=-1 && fileName.indexOf("Suite")==-1) {
    ...
    private static void generateSuite(String javaSeleneseFileDirectoryName) throws IOException {
        ...
        Iterator<String> i = generatedJavaClassNames.iterator();
        while (i.hasNext()) {
            String generatedJavaClassName = i.next();
    ...
    private static String XlateString(String base, String htmlSeleneseFileName, String htmlSelenese) {
        ...
        "import ch.vd.uniregctb.common.AbstractSeleniumTest;\n" +
        "/**\n" +
        " * @author XlateHtmlSeleneseToJava\n" +
        " * Generated from " + htmlSeleneseFileName + ".\n" +
        " */\n" +
        "public class " + base + " extends AbstractSeleniumTest\n" +
        "{\n" +
        ...
        if (!silentMode) {
            System.out.println("- Body after1 ------------------------------------------------------------\n" + body);
        }
        ...
        body = body.replaceAll("<td/>", "");
        if (!silentMode) {
            System.out.println("- Body after2 ------------------------------------------------------------\n" + body);
        }
        ...
        if (!silentMode) {
            System.out.println("- Body after3 ------------------------------------------------------------\n" + java);
        }
