 ...
 *
 */
public class Ec_6000_05_Separation_SuisseAvecPermisB_Scenario extends EvenementCivilScenario {

	public static final String NAME = "6000_05_Separation";
	...
	public String getDescription() {
		return "Séparation d'un habitant suisse marié avec un étranger ayant le permis B";
	}
	...
	protected void initServiceCivil() {
		serviceCivilService.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				setPermis(indMomo, TypePermis.ANNUEL, RegDate.get(1963, 8, 20), null, false);
	...
	public void check2() {
...

		{
			...
			assertEquals(ffp.getModeImposition(), expected, "Le mode d'imposition n'est pas " + expected);
