...
public class AnnulationMariageAdapterTest extends AbstractEvenementAdapterTest {
	
	private static final Log LOGGER = LogFactory.getLog(AnnulationMariageAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "AnnulationMariageAdapterTest.xml";
