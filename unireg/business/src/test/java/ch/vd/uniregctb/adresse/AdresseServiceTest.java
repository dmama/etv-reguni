...
public class AdresseServiceTest extends BusinessTest {
	...
	public void testGetAdressesFiscalNonHabitantAvecDomicileSeulement() throws Exception {
		...
		AdressesFiscales adrs = adresseService.getAdressesFiscales(nonhabitant, null);
		assertNotNull(adrs.courrier);
		assertNotNull(adrs.domicile);
		assertNotNull(adrs.poursuite);
		assertNotNull(adrs.representation);

		assertNotNull(adresseService.getAdresseFiscale(nonhabitant, TypeAdresseTiers.COURRIER, null));
		assertNotNull(adresseService.getAdresseFiscale(nonhabitant, TypeAdresseTiers.DOMICILE, null));
		assertNotNull(adresseService.getAdresseFiscale(nonhabitant, TypeAdresseTiers.POURSUITE, null));
		assertNotNull(adresseService.getAdresseFiscale(nonhabitant, TypeAdresseTiers.REPRESENTATION, null));
	}
	...
	public void testGetAdressesFiscalHistoNonHabitantAvecDomicileSeulement() throws Exception {
		...
		AdressesFiscalesHisto adrs = adresseService.getAdressesFiscalHisto(nonhabitant);
		assertNotNull(adrs.courrier);
		assertNotNull(adrs.domicile);
		assertNotNull(adrs.poursuite);
		assertNotNull(adrs.representation);
	...
	public void testGetAdressesFiscalHistoSansTiers() throws Exception {
		assertNull(adresseService.getAdressesFiscales(null, date(2000, 1, 1)));
		assertNull(adresseService.getAdresseFiscale(null, TypeAdresseTiers.COURRIER, date(2000, 1, 1)));
		assertNull(adresseService.getAdresseFiscale(null, TypeAdresseTiers.DOMICILE, date(2000, 1, 1)));
		assertNull(adresseService.getAdresseFiscale(null, TypeAdresseTiers.POURSUITE, date(2000, 1, 1)));
		assertNull(adresseService.getAdresseFiscale(null, TypeAdresseTiers.REPRESENTATION, date(2000, 1, 1)));
	}
	...
	public void testGetAdressesFiscalHistoSansAdresseFiscale() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses courriers
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(1980, 1,
						1), date(1987, 12, 11));
				...
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.LesClees.ChampDuRaffour, null, MockLocalite.LesClees,
						date(2001, 6, 4), null);

				// adresses principales/poursuite
				addAdresse(pierre, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(1980,
						1, 1), date(1987, 12, 11));
		...
		final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(habitant);
	...
	public void testGetAdressesFiscalesSansAdresseCivile() throws Exception {
		...
		{
			final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(nonhabitant);
			assertNotNull(adresses);
		...
		// Vérification des adresses ponctuelles
		{
			...
			{
				final AdressesFiscales adresses = adresseService.getAdressesFiscales(nonhabitant, date(1980, 1, 1));
				assertNotNull(adresses);
			...
			{
				final AdressesFiscales adresses = adresseService.getAdressesFiscales(nonhabitant, date(1980, 7, 1));
				assertNotNull(adresses);
			...
			{
				final AdressesFiscales adresses = adresseService.getAdressesFiscales(nonhabitant, date(1998, 7, 1));
				assertNotNull(adresses);
	...
	public void testGetAdressesFiscalHistoCasGeneral() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses courriers
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(2000, 1,
						1), date(2000, 9, 19));
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.CossonayVille.AvenueDuFuniculaire, null, MockLocalite.CossonayVille,
						date(2000, 9, 20), date(2002, 2, 27));
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.LesClees.ChampDuRaffour, null, MockLocalite.LesClees,
						date(2002, 2, 28), date(2002, 3, 14));
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(2002, 3,
						15), null);

				// adresses principales/poursuite
				addAdresse(pierre, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(2000,
						1, 1), null);
			}
		});
	...
	public void testGetAdressesFiscalHistoSurchargeCivil() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses courriers
				addAdresse(paul, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne,
						date(2000, 1, 1), null);

				// adresses principales/poursuite
				addAdresse(paul, EnumTypeAdresse.PRINCIPALE, MockRue.Bex.RouteDuBoet, null, MockLocalite.Bex, date(2000, 1, 1), null);
			}
		});
	...
	public void testGetAdressesFiscalHistoSurchargeAutreTiers() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses courriers
				addAdresse(paul, EnumTypeAdresse.COURRIER, MockRue.Lausanne.RouteMaisonNeuve, null, MockLocalite.Lausanne,
						date(2000, 1, 1), null);

				// adresses principales/poursuite
				addAdresse(paul, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.RouteMaisonNeuve, null, MockLocalite.Lausanne, date(2000, 1,
						1), null);

				MockIndividu pierre = addIndividu(noAutreIndividu, date(1953, 11, 2), "Dubois", "Pierre", true);

				// adresses courriers
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.Bex.RouteDuBoet, null, MockLocalite.Bex, date(2000, 1, 1), null);

				// adresses principales/poursuite
				addAdresse(pierre, EnumTypeAdresse.PRINCIPALE, MockRue.Bex.RouteDuBoet, null, MockLocalite.Bex, date(2000, 1, 1), null);
			}
		});
	...
	public void testGetAdressesFiscalHistoCasParticulier2() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses principales/poursuite
				addAdresse(paul, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(2000, 1,
						1), null);
			}
		});
	...
	public void testGetAdressesFiscalHistoCasParticulier3() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				addAdresse(paul, EnumTypeAdresse.COURRIER, MockRue.CossonayVille.AvenueDuFuniculaire, null, MockLocalite.CossonayVille,
						date(2000, 7, 13), null);
	...
	public void testGetAdressesFiscalAvecAdresseAnnulee() throws Exception {
		 ...
		 */
		{
			...
			final AdressesFiscales adresses = adresseService.getAdressesFiscales(habitant, null);
...

		{
			...
			final AdressesFiscales adresses = adresseService.getAdressesFiscales(habitant, date(2000, 4, 1));
	...
	public void testGetAdressesFiscalHistoMenageCommun() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses courriers
				addAdresse(virginie, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeMarcelin, null, MockLocalite.Lausanne, date(2002,
						2, 2), null);

				// adresses principales/poursuite
				addAdresse(virginie, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.AvenueDeMarcelin, null, MockLocalite.Lausanne, date(2002,
						2, 2), null);
		...
		// Vérification des adresses
		final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(menage);
		assertNotNull(adresses);
		assertEquals(1, adresses.courrier.size());
		assertAdressesEquals(adresses.courrier, adresses.representation);
		assertEquals(1, adresses.poursuite.size());
	...
	public void testGetAdressesFiscalHistoMenageCommunNonHabitants() throws Exception {
		...
		{
			// Vérification des adresses
			final AdressesFiscales adresses = adresseService.getAdressesFiscales(menage, date(2008, 1, 1));
			assertNotNull(adresses);
	...
	public void testGetAdressesFiscalHistoTutelle() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses courriers
				addAdresse(jean, EnumTypeAdresse.COURRIER, MockRue.CossonayVille.AvenueDuFuniculaire, null, MockLocalite.CossonayVille,
						date(1985, 4, 1), null);

				// adresses principales/poursuite
				addAdresse(jean, EnumTypeAdresse.PRINCIPALE, MockRue.CossonayVille.AvenueDuFuniculaire, null, MockLocalite.CossonayVille,
						date(1985, 4, 1), null);
			}
		});
		...
		// Vérification des adresses
		{
			...
			final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(pupille);
			assertNotNull(adresses);
	...
	public void testGetAdressesFiscalHistoCoupleTutellePrincipal() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				addAdresse(jeanne, EnumTypeAdresse.PRINCIPALE, MockRue.Bex.RouteDuBoet, null, MockLocalite.Bex, date(2000, 1, 1), null);
		...
		// Vérification des adresses du principal
		{
			...
			final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(principal);
			assertNotNull(adresses);
		...
		// Vérification des adresses du conjoint
		{
			...
			final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(conjoint);
			assertNotNull(adresses);
	...
	public void testGetAdressesFiscalHistoCoupleTutellePrincipalEtConjoint() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				addAdresse(jacky, EnumTypeAdresse.PRINCIPALE, MockRue.LesClees.ChampDuRaffour, null, MockLocalite.LesClees,
						date(1985, 4, 1), null);
			}
		});
	...
	public void testGetAdressesFiscalDetectionRecursionInfinie() throws Exception {
		...
		// Vérification de la détection du cycle
		{
			...
			try {
				adresseService.getAdressesFiscales(pupille, date(2000, 1, 1));
				fail();
			}
			...
			try {
				adresseService.getAdresseFiscale(pupille, TypeAdresseTiers.COURRIER, date(2000, 1, 1));
				fail();
			}
			catch (AdressesResolutionException ok) {
				// ok
			}
			adresseService.getAdresseFiscale(pupille, TypeAdresseTiers.REPRESENTATION, date(2000, 1, 1));
			adresseService.getAdresseFiscale(pupille, TypeAdresseTiers.POURSUITE, date(2000, 1, 1));
			adresseService.getAdresseFiscale(pupille, TypeAdresseTiers.DOMICILE, date(2000, 1, 1));

			try {
				adresseService.getAdressesFiscalHisto(pupille);
				fail();
			}
			catch (AdressesResolutionException ok) {
				// ok
	...
	public void testGetAdressesFiscalHistoAvecAdresseCivile() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				// adresses principales/poursuite
				addAdresse(paul, EnumTypeAdresse.PRINCIPALE, MockRue.CossonayVille.AvenueDuFuniculaire, null, MockLocalite.CossonayVille,
						date(2000, 1, 1), null);
			}
		});
	...
	public void testGetAdressesFiscalHistoDefaultAdressesPrincipalCivil() throws Exception {
		...
		{
			{
				final AdressesFiscales adresses1950 = adresseService.getAdressesFiscales(habitant, date(1950, 1, 1));
			...
			{
				final AdressesFiscales adresses1982 = adresseService.getAdressesFiscales(habitant, date(1982, 1, 1));
			...
			{
				final AdressesFiscales adresses1995 = adresseService.getAdressesFiscales(habitant, date(1995, 1, 1));
			...
			{
				final AdressesFiscales adresses2004 = adresseService.getAdressesFiscales(habitant, date(2004, 1, 1));
	...
	public void testGetAdressesFiscalHistoDefaultAdressesCourrierCivil() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				addAdresse(pierre, EnumTypeAdresse.PRINCIPALE, MockRue.CossonayVille.CheminDeRiondmorcel, null, MockLocalite.CossonayVille,
						date(1987, 12, 12), date(2001, 6, 3));
				addAdresse(pierre, EnumTypeAdresse.PRINCIPALE, MockRue.LesClees.ChampDuRaffour, null, MockLocalite.LesClees, date(2001, 6,
						4), null);
			}
		});
	...
	public void testGetAdressesFiscalHistoEntrepriseSansAdresseFiscale() throws Exception {
		...
		servicePM.setUp(new MockServicePM() {
			@Override
			protected void init() {
				MockPersonneMorale ent = addPM(noEntreprise, "Ma Petite Entreprise", EnumFormeJuridique.SOCIETE_RESPONSABILITE_LIMITEE,
						date(1970, 7, 1), null);
...

		{
			...
			// Vérification des adresses
			final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(entreprise);
			assertNotNull(adresses);
	...
	public void testGetAdresseFiscalDebiteurPrestationImposableSansContribuableAssocie() throws Exception {
...

		{
			...
			// Vérification des adresses ponctuelles
			{
				final AdressesFiscales adresses1950 = adresseService.getAdressesFiscales(debiteur, date(1950, 1, 1));
				assertNotNull(adresses1950);
				assertNull(adresses1950.courrier);
				assertNull(adresses1950.representation);
				assertNull(adresses1950.poursuite);
			...
			{
				final AdressesFiscales adresses1982 = adresseService.getAdressesFiscales(debiteur, date(1982, 1, 1));
				assertNotNull(adresses1982);
			...
			// Vérification des adresses historiques
			{
				...
				final AdressesFiscalesHisto adresses = adresseService.getAdressesFiscalHisto(debiteur);
				assertNotNull(adresses);
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				MockAdresse adresse = (MockAdresse) addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeBeaulieu, null,
						MockLocalite.Lausanne, date(1980, 1, 1), null);
	...
	public void testGetAdresseEnvoiDebiteurPrestationImposableAvecAdresseCourrierSurPersonnePhysique() throws Exception {
...

		{
			...
			{
				final AdressesFiscales adresses1990 = adresseService.getAdressesFiscales(debiteur, date(1990, 1, 1));
	...
	public void testAddAdresseSurNonHabitant() throws Exception {
		...
		AdressesFiscales adresses = adresseService.getAdressesFiscales(nh, null);
		assertNotNull(adresses);
		...
		AdressesFiscalesHisto adressesHisto = adresseService.getAdressesFiscalHisto(nh);
		...
		adresses = adresseService.getAdressesFiscales(nh, null);
		assertNotNull(adresses);
		assertAdresse(date(1988, 3, 2), null, "Lausanne", Source.FISCALE, false, adresses.courrier);
		...
		adressesHisto = adresseService.getAdressesFiscalHisto(nh);
		assertNotNull(adressesHisto);
		assertEquals(1, adressesHisto.courrier.size());
	...
	public void testAddAdresseAvecAdresseCourrierExistante() throws Exception {
		...
		// Teste des adresses résultantes
		AdressesFiscalesHisto adressesHisto = adresseService.getAdressesFiscalHisto(habitant);
		assertNotNull(adressesHisto);
		assertEquals(2, adressesHisto.courrier.size());
	...
	public void testAnnulerAdresseSansAdressePrecedenteExistante() throws Exception {
		...
		// Teste des adresses résultantes
		AdressesFiscalesHisto adressesHisto = adresseService.getAdressesFiscalHisto(tiers);
		assertNotNull(adressesHisto);
		assertEquals(1, adressesHisto.courrier.size());
	...
	public void testGetAdressesMenageCommunAvecRapportsAnnules() throws Exception {
		...
		// Vérification des adresses
		final AdressesFiscalesHisto adressesHisto = adresseService.getAdressesFiscalHisto(menage);
		assertNotNull(adressesHisto);
		...
		final List<String> nomCourrier = adresseService.getNomCourrier(menage, date(2005,1,1));
		assertEmpty(nomCourrier);

		final AdresseEnvoiDetaillee adresseEnvoi = adresseService.getAdresseEnvoi(menage, date(2007,3,3));
	...
	private void assertAdressesByTypeEquals(final AdressesFiscales adresses, Tiers tiers, RegDate date) throws AdressesResolutionException {
		assertAdressesEquals(adresses.courrier, adresseService.getAdresseFiscale(tiers, TypeAdresseTiers.COURRIER, date));
		assertAdressesEquals(adresses.representation, adresseService.getAdresseFiscale(tiers, TypeAdresseTiers.REPRESENTATION, date));
		assertAdressesEquals(adresses.poursuite, adresseService.getAdresseFiscale(tiers, TypeAdresseTiers.POURSUITE, date));
		assertAdressesEquals(adresses.domicile, adresseService.getAdresseFiscale(tiers, TypeAdresseTiers.DOMICILE, date));
	}
	...
	public void testAdresseCurateurDeMadameHabitanteAvecMonsieurNonHabitant() throws Exception {
		...
		serviceCivil.setUp(new MockServiceCivil() {
			...
			protected void init() {
				...
				addAdresse(albertine, EnumTypeAdresse.COURRIER, MockRue.Lausanne.RouteMaisonNeuve, null, MockLocalite.Lausanne, date(1980, 1, 1), null);
				addAdresse(albertine, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.RouteMaisonNeuve, null, MockLocalite.Lausanne, date(1980, 1, 1), null);
				...
				addAdresse(pierre, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(1980, 1, 1), null);
				addAdresse(pierre, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.AvenueDeBeaulieu, null, MockLocalite.Lausanne, date(1980, 1, 1), null);
				...
				addAdresse(nicolas, EnumTypeAdresse.COURRIER, MockRue.Lausanne.AvenueDeMarcelin, null, MockLocalite.Lausanne, date(1980, 1, 1), null);
				addAdresse(nicolas, EnumTypeAdresse.PRINCIPALE, MockRue.Lausanne.AvenueDeMarcelin, null, MockLocalite.Lausanne, date(1980, 1, 1), null);
			}
		});

		final PersonnePhysique monsieur = createNonHabitant("Talon", "Achile");
		final PersonnePhysique madame = createHabitant(noIndividuMadame);
		final MenageCommun mc = createMenageCommun(monsieur, madame, date(2000,1,1));

		final PersonnePhysique tuteurMonsieur = createHabitant(noIndividuTuteurMonsieur);
		...
		final PersonnePhysique curateurMadame = createHabitant(noIndividuCurateurMadame);
		...
		final AdresseEnvoiDetaillee adresseEnvoi = adresseService.getAdresseEnvoi(mc, null);
	...
	private PersonnePhysique createHabitant(long noIndividu) {
		final PersonnePhysique habitant = new PersonnePhysique(true);
		habitant.setNumeroIndividu(noIndividu);
		return (PersonnePhysique) tiersDAO.save(habitant);
	}

	private PersonnePhysique createNonHabitant(String nom, String prenom) {
	...
	private MenageCommun createMenageCommun(PersonnePhysique principal, PersonnePhysique conjoint, RegDate dateDebut) {
		final MenageCommun mc = (MenageCommun) tiersDAO.save(new MenageCommun());
		final AppartenanceMenage rpp1 = new AppartenanceMenage(date(2000,1,1), null, principal, mc);
		principal.addRapportSujet(rpp1);
		mc.addRapportObjet(rpp1);
		final AppartenanceMenage rpp2 = new AppartenanceMenage(date(2000,1,1), null, conjoint, mc);
		conjoint.addRapportSujet(rpp2);
		mc.addRapportObjet(rpp2);
		return mc;
	}
}
