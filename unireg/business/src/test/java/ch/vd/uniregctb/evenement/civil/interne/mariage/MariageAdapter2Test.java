...
public class MariageAdapter2Test extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(MariageAdapter2Test.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "MariageAdapter2Test.xml";
