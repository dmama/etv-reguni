...
public class AnnulationReconciliationAdapterTest extends AbstractEvenementAdapterTest {

	private static final Log LOGGER = LogFactory.getLog(AnnulationReconciliationAdapterTest.class);
	
	/**
	 * Le fichier de données de test.
	 */
	private static final String DB_UNIT_DATA_FILE = "AnnulationReconciliationAdapterTest.xml";
