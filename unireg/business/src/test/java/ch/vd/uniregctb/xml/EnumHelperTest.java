...
public class EnumHelperTest {
	...
	public void testCoreToXmlEnumConversionsNoCrashingCase() throws Exception {
		...
		knownCrashingEnums.put(Pair.<String, Class<? extends Enum>>of("coreToXMLv1", TypeEtatDocumentFiscal.class), EnumSet.of(TypeEtatDocumentFiscal.RAPPELEE, TypeEtatDocumentFiscal.SUSPENDUE));
		knownCrashingEnums.put(Pair.<String, Class<? extends Enum>>of("coreToXMLv2", TypeEtatDocumentFiscal.class), EnumSet.of(TypeEtatDocumentFiscal.RAPPELEE, TypeEtatDocumentFiscal.SUSPENDUE));
		knownCrashingEnums.put(Pair.<String, Class<? extends Enum>>of("coreToXMLv3", TypeEtatDocumentFiscal.class), EnumSet.of(TypeEtatDocumentFiscal.RAPPELEE, TypeEtatDocumentFiscal.SUSPENDUE));
