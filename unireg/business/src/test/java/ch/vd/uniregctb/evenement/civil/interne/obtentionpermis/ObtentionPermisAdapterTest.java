 ...
 * <a>
 */
public class ObtentionPermisAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(ObtentionPermisAdapterTest.class);
