...
public class EditiqueCompositionServiceTest extends BusinessTest {
	...
	protected void runOnSetUp() throws Exception {
		...
		service.setImpressionDIHelper(getBean(ImpressionDeclarationImpotOrdinaireHelper.class, "impressionDIHelper"));
		service.setImpressionLRHelper(getBean(ImpressionListeRecapHelper.class, "impressionLRHelper"));
		service.setImpressionSommationDIHelper(getBean(ImpressionSommationDIHelper.class, "impressionSommationDIHelper"));
		...
		service.setImpressionConfirmationDelaiHelper(getBean(ImpressionConfirmationDelaiHelper.class, "impressionConfirmationDelaiHelper"));
