 ...
 *
 */
public class LeveeTutelleTest extends AbstractEvenementCivilInterneTest {
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "LeveeTutelleTest.xml";
	...
	private LeveeTutelle createLeveeTutelle(Individu pupille) {
		return new LeveeTutelle(pupille, null, DATE_LEVEE_TUTELLE, 4848, context);
	}
