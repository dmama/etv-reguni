...
public class EvenementCivilUnitaireListenerTest extends BusinessTest {
	...
	public void onSetUp() throws Exception {
		...
		evenementCivilUnitaireMDP.setEvenementCivilRegrouper(getBean(EvenementCivilRegrouper.class, "evenementCivilRegrouper"));
		evenementCivilUnitaireMDP.setEvenementCivilUnitaireDAO(evenementCivilUnitaireDAO);
