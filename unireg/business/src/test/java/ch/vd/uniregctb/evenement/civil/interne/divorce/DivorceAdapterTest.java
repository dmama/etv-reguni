 ...
 *
 */
public class DivorceAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(DivorceAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "DivorceAdapterTest.xml";
