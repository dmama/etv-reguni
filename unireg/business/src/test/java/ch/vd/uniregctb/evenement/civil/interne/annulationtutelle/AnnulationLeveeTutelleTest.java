...
public class AnnulationLeveeTutelleTest extends AbstractEvenementCivilInterneTest {
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "AnnulationLeveeTutelleTest.xml";
	...
	private AnnulationLeveeTutelle createAnnulationLeveeTutelle(Individu pupille) {
		return new AnnulationLeveeTutelle(pupille, null, DATE_ANNULATION_TUTELLE, 4848, context);
	}
}
