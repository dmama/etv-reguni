...
import ch.vd.uniregctb.evenement.civil.regpp.jms.EvenementCivilListener;
import ch.vd.uniregctb.evenement.civil.regpp.jms.EvenementCivilListenerTest;
import ch.vd.uniregctb.evenement.civil.regpp.jms.MockEsbMessage;
...
public class EvenementCivilTest extends BusinessTest {
	...
	private static void assertNomIndividu(String nom, String prenom, ServiceCivilCache cache, final long noIndividu) {
		final Individu individu = cache.getIndividu(noIndividu);
