 ...
 *
 */
public class AnnulationPermisAdapter2Test extends AbstractEvenementAdapterTest {

	private static final Log LOGGER = LogFactory.getLog(AnnulationPermisAdapter2Test.class);
