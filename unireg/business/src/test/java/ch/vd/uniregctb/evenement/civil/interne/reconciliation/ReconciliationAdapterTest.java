...
public class ReconciliationAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(ReconciliationAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "ReconciliationAdapterTest.xml";
