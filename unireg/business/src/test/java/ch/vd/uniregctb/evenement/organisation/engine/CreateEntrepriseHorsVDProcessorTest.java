...
public class CreateEntrepriseHorsVDProcessorTest extends AbstractEvenementOrganisationProcessorTest {
	...
	public void testCreationHorsVDSP() throws Exception {
		...
		// Mise en place service mock
		final Long noOrganisation = 101202100L;
		final MockOrganisation org = MockOrganisationFactory.createSimpleEntrepriseRC(noOrganisation, noOrganisation + 1000000, "Robert Alkan et autres fous", RegDate.get(2015, 6, 24), null, FormeLegale.N_0103_SOCIETE_NOM_COLLECTIF,
		                                                                              MockCommune.Zurich);
		MockSiteOrganisationFactory.addSite(1012021001234L,
		                                    org,
		                                    RegDate.get(2015, 6, 24),
