...
public abstract class AbstractEvenementAdapterTest extends BusinessTest {

	//private static final Logger LOGGER = Logger.getLogger(AbstractEvenementAdapterTest.class);
