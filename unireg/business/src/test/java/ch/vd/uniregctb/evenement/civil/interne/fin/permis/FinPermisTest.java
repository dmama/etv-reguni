...
public class FinPermisTest extends WithoutSpringTest {
	...
	ServiceCivilService serviceCivil = new DefaultMockServiceCivil() {
		...
		protected void init() {
			...
			setPermis(roberto, TypePermis.ETABLISSEMENT, DATE_FIN_PERMIS.addYears(-5), DATE_FIN_PERMIS, false);
			...
			setPermis(rosa, TypePermis.ETABLISSEMENT, DATE_FIN_PERMIS.addYears(-5), DATE_FIN_PERMIS, false);
		}
	};
