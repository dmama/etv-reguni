...
public class VeuvageAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(VeuvageAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "VeuvageAdapterTest.xml";
