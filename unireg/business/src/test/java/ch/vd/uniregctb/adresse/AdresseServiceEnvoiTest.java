...
public class AdresseServiceEnvoiTest extends BusinessTest {
	...
	public void testGetAdresseEnvoiPersonnePhysiqueSansComplementNiCasePostale() throws Exception {
...

		{
			...
			AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(habitant, null);
			...
			List<String> nomCourrier = adresseService.getNomCourrier(habitant, null);
	...
	public void testGetAdresseEnvoiCoupleSansComplementNiCasePostale() throws Exception {
...

		{
			...
			AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(menage, null);
			assertNotNull(adresse);
			...
			List<String> nomCourrier = adresseService.getNomCourrier(menage, null);
			assertNotNull(nomCourrier);
	...
	public void testGetAdresseEnvoiDebiteurPrestationImposableSansAdresseSurPersonnePhysique() throws Exception {
...

		{
			...
			AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(debiteur, null);
			assertNotNull(adresse);
			...
			List<String> nomCourrier = adresseService.getNomCourrier(debiteur, null);
			assertNotNull(nomCourrier);
			assertEquals(1, nomCourrier.size());
	...
	public void testGetAdresseEnvoiDebiteurPrestationImposableSurCollectiviteAdministrative() throws Exception {
...

		{
			...
			AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(tribunal, null);
			assertNotNull(adresse);
			...
			List<String> nomCourrier = adresseService.getNomCourrier(tribunal, null);
			assertNotNull(nomCourrier);
			assertEquals(1, nomCourrier.size());
	...
	public void testGetAdresseEnvoiCollectiviteAdministrative() throws Exception {
...

		{
			...
			AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(collectivite, null);
			assertNotNull(adresse);
			...
			List<String> nomCourrier = adresseService.getNomCourrier(collectivite, null);
			assertNotNull(nomCourrier);
			assertEquals(2, nomCourrier.size());
	...
	public void testGetAdresseEnvoiCoupleEnCasDeces() throws Exception {
		...
		AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(menage, aujourdhui);
		assertNotNull(adresse);
		assertEquals("Monsieur et Madame", adresse.getLigne1());
		...
		adresse = adresseService.getAdresseEnvoi(menage, aujourdhui);
		assertNotNull(adresse);
	...
	public void testGetAdresseEnvoiEntrangere() throws Exception {
		...
		AdresseEnvoiDetaillee adresse = adresseService.getAdresseEnvoi(paul, aujourdhui);
		assertNotNull(adresse);
		assertEquals("Monsieur", adresse.getLigne1());
		assertEquals("Paul Duchêne", adresse.getLigne2());
