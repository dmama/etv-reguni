...
public class CorrectionDateNaissanceAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(CorrectionDateNaissanceAdapterTest.class);
	...
	private static final String DB_UNIT_DATA_FILE = "CorrectionDateNaissanceAdapterTest.xml";

	/** L'index global. */
	private GlobalTiersSearcher searcher;

	public CorrectionDateNaissanceAdapterTest() {
