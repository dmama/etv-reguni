 ...
 *
 */
public class TutelleAdapter2Test extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(TutelleAdapter2Test.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "TutelleAdapter2Test.xml";
