 ...
 *
 */
public class SuppressionNationaliteAdapterTest extends AbstractEvenementAdapterTest {

	private static final Log LOGGER = LogFactory.getLog(SuppressionNationaliteAdapterTest.class);
