 ...
 *
 */
public class AnnulationTutelleAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(AnnulationTutelleAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "AnnulationTutelleAdapterTest.xml";
