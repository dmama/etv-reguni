...
public class AnnulationVeuvageAdapterTest extends AbstractEvenementAdapterTest {

	private static final Log LOGGER = LogFactory.getLog(AnnulationVeuvageAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "AnnulationVeuvageAdapterTest.xml";
