...
public class InboxElementTest extends WithoutSpringTest {
	...
	public void testStreamContent() throws Exception {
		...
		final InboxElement elt = new InboxElement("Mon nom à moi", "text/plain", src, 100);
	...
	public void testNoExpiration() throws Exception {
		final InputStream src = buildInputStream();
		final InboxElement elt = new InboxElement("Mon nom à moi", "text/plain", src, 0);
		Assert.assertFalse(elt.isExpired());
		Thread.sleep(200);
		Assert.assertFalse(elt.isExpired());
	...
	public void testNaturalOrdering() throws Exception {
		...
		final InboxElement elt1 = new InboxElement("Un", "text/plain", src1, 0);
		Thread.sleep(50);
		final InputStream src2 = buildInputStream();
		final InboxElement elt2 = new InboxElement("Deux", "text/plain", src2, 0);
	...
	public void testNullInputStream() throws Exception {
		final InboxElement elt = new InboxElement("Rien", "text/csv", null, 0);
