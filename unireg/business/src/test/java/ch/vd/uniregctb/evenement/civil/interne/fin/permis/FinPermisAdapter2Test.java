...
public class FinPermisAdapter2Test extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(FinPermisAdapter2Test.class);
	...
	private static final String DB_UNIT_DATA_FILE = "FinPermisAdapter2Test.xml";
