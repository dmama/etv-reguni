...
public class ChangementNomAdapterTest extends AbstractEvenementAdapterTest {

	private static final long NUMERO_CONTRIBUABLE = 6791L;
	private static final long NUMERO_CONTRIBUABLE_DIRTY = 6792L;

	private static final Logger LOGGER = Logger.getLogger(ChangementNomAdapterTest.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "ChangementNomAdapterTest.xml";
	...
	public ChangementNomAdapterTest() {
