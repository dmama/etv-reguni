...
public class FinNationaliteAdapterTest extends AbstractEvenementAdapterTest {
	
	private static final Logger LOGGER = Logger.getLogger(FinNationaliteAdapterTest.class);
	
	private static final long NUMERO_INDIVIDU = 34567;
	
	/** Le fichier de données de test. */
	private static final String DB_UNIT_DATA_FILE = "FinNationaliteAdapterTest.xml";
