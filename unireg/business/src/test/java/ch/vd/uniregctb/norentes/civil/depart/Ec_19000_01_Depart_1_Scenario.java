...
public class Ec_19000_01_Depart_1_Scenario extends EvenementCivilScenario {
	...
	public void check3() throws Exception {
		...
		// On check que Alain  est parti
		{
			...
			assertEquals(NouvelleCommuneZurich, ffpOuvert.getNumeroOfsAutoriteFiscale(), "Le for ouvert n'est pas sur Zurich");
	...
	private void addAdresseZurich(MockIndividu ind) {
		...
		ind.addAdresse(new MockAdresse(TypeAdresseCivil.PRINCIPALE, MockRue.Zurich.GloriaStrasse, null, dateArriveeZurich, null));
	}
