...
public class DebiteurPrestationImposableIndexableTest extends BusinessTest {
	...
	public void testIndexationDebiteurEtContribuable() throws Exception {
		...
		/* On vérifie que le débiteur et le contribuables sont bien indexés */
		{
			...
			final TiersIndexedData dataNh = (data0.getNumero() == numeros.noCtbNh ? data0 : data1);
			final TiersIndexedData dataDpi = (data0.getNumero() == numeros.noCtbNh ? data1 : data0);
	...
	public void testIndexationDebiteurEtEntreprise() throws Exception {
		...
		/* On vérifie que le débiteur et le contribuables sont bien indexés */
		{
			...
			final TiersIndexedData dataNh = (data0.getNumero() == numeros.noCtbEnt ? data0 : data1);
			final TiersIndexedData dataDpi = (data0.getNumero() == numeros.noCtbEnt ? data1 : data0);
