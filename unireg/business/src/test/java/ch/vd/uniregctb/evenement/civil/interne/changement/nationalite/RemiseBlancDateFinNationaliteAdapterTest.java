...
public class RemiseBlancDateFinNationaliteAdapterTest extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(RemiseBlancDateFinNationaliteAdapterTest.class);

	private static final long NUMERO_INDIVIDU = 93256;

	/** Le fichier de données de test. */
	private static final String DB_UNIT_DATA_FILE = "RemiseBlancDateFinNationaliteAdapterTest.xml";
