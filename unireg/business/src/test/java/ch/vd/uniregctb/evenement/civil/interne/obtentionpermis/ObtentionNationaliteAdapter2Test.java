 ...
 */
public class ObtentionNationaliteAdapter2Test extends AbstractEvenementAdapterTest {

	private static final Logger LOGGER = Logger.getLogger(ObtentionNationaliteAdapter2Test.class);
