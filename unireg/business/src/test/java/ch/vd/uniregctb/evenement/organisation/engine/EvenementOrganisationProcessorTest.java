...
public class EvenementOrganisationProcessorTest extends AbstractEvenementOrganisationProcessorTest {
	...
	public void testEvenementNeutreEntraineReindexation() throws Exception {
		...
		serviceOrganisation.setUp(new MockServiceOrganisation() {
			...
			protected void init() {
				addOrganisation(
						MockOrganisationBuilder.createSimpleEntrepriseRC(noOrganisation, "Synergy SA", RegDate.get(2000, 1, 1), FormeLegale.N_0106_SOCIETE_ANONYME, MockCommune.Lausanne.getNoOFS()));
			}
		});
