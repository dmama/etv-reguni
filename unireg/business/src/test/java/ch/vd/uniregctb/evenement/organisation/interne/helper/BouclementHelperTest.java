...
public class BouclementHelperTest {
	...
	public void testCreateBouclementSelonSemestre() throws Exception {
		...
		final Bouclement bouclement1erSemestre = BouclementHelper.createBouclementSelonSemestre(RegDate.get(2015, 1, 1));
		...
		final Bouclement bouclement1erSemestreLimite = BouclementHelper.createBouclementSelonSemestre(RegDate.get(2015, 6, 30));
		...
		final Bouclement bouclement2erSemestreLimite = BouclementHelper.createBouclementSelonSemestre(RegDate.get(2015, 7, 1));
		...
		final Bouclement bouclement2erSemestre = BouclementHelper.createBouclementSelonSemestre(RegDate.get(2015, 12, 31));
