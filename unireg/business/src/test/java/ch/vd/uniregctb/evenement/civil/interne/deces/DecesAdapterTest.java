...
public class DecesAdapterTest extends AbstractEvenementAdapterTest {
	...
	public void testGetConjointSurvivantCelibataire() throws Exception {
		...
		DecesAdapter adapter = new DecesAdapter(evenement, contextSimple);
	...
	private static final Logger LOGGER = Logger.getLogger(DecesAdapterTest.class);
