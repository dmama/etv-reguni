...
import ch.vd.uniregctb.evenement.civil.interne.depart.DepartHandler;
...
public class MockDepartAdapter extends DepartAdapter {
	...
	protected MockDepartAdapter(EvenementCivilExterne evenement, EvenementCivilContext context, DepartHandler handler) throws EvenementCivilInterneException {
