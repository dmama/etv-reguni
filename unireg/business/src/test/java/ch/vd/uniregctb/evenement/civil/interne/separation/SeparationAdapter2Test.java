 ...
 *
 */
public class SeparationAdapter2Test extends AbstractEvenementAdapterTest {
	
	private static final Logger LOGGER = Logger.getLogger(SeparationAdapter2Test.class);
	 ...
	 */
	private static final String DB_UNIT_DATA_FILE = "SeparationAdapter2Test.xml";
