...
public class AnnulationSeparationAdapterTest extends AbstractEvenementAdapterTest {

	private static final Log LOGGER = LogFactory.getLog(AnnulationSeparationAdapterTest.class);
	
	/**
	 * Le fichier de données de test.
	 */
	private static final String DB_UNIT_DATA_FILE = "AnnulationSeparationAdapterTest.xml";
