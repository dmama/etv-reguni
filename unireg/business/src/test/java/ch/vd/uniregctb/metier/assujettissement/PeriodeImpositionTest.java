...
public class PeriodeImpositionTest extends MetierTest {
	...
	public void testDetermineVenteImmeubleContribuableHorsSuisse() throws Exception {
		...
		// 2006
		{
			...
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(0));
		}
		...
		// 2007
		{
			...
			assertPeriodeImposition(date(2007, 1, 1), dateVente, TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(0)); // [UNIREG-1742] vente de l'immeuble -> déclaration pas optionnelle
		}
		...
		// 2000-2008
		{
			...
			assertPeriodeImposition(dateAchat, date(2000, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(0)); // [UNIREG-1742] la DI est optionnelle dès la première année
			assertPeriodeImposition(date(2001, 1, 1), date(2001, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
			assertPeriodeImposition(date(2002, 1, 1), date(2002, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(2));
			assertPeriodeImposition(date(2003, 1, 1), date(2003, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(3));
			assertPeriodeImposition(date(2004, 1, 1), date(2004, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(4));
			assertPeriodeImposition(date(2005, 1, 1), date(2005, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(5));
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(6));
			assertPeriodeImposition(date(2007, 1, 1), dateVente, TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(7));
		}
	}
	...
	public void testDetermineAchatsEtVentesMultipleHorsSuisse() throws Exception {
		...
		// 2008
		{
			...
			assertPeriodeImposition(immeuble1.getDateDebut(), immeuble1.getDateFin(), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(0)); // pas optionnelle car vente de l'immeuble
			assertPeriodeImposition(immeuble2.getDateDebut(), immeuble2.getDateFin(), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(1)); // pas optionnelle car vente de l'immeuble
		}
	...
	public void testDetermineArriveeHorsSuisseAvecImmeuble() throws Exception {
		...
		// 2007
		{
			...
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
		...
		// 2008
		{
			...
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
		...
		// 2000-2008
		{
			...
			assertPeriodeImposition(date(2000, 1, 1), date(2000, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(0)); // [UNIREG-1742] la DI est optionnelle dès la première année
			assertPeriodeImposition(date(2001, 1, 1), date(2001, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
			assertPeriodeImposition(date(2002, 1, 1), date(2002, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(2));
			assertPeriodeImposition(date(2003, 1, 1), date(2003, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(3));
			assertPeriodeImposition(date(2004, 1, 1), date(2004, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(4));
			assertPeriodeImposition(date(2005, 1, 1), date(2005, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(5));
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(6));
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(7));
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(8));
		}
	}
	...
	public void testDetermineArriveeHorsSuisseAchatImmeubleEtDepartHorsSuisseDansLAnnee() throws Exception {
		...
		// 2007
		{
			...
			assertPeriodeImposition(dateArrivee, date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
		...
		// 2008
		{
			...
			assertEquals(1, list.size());
			// hors-Suisse toute l'année
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(0));
		}
		...
		// 2000-2008
		{
			...
			assertEquals(2, list.size());
			assertPeriodeImposition(dateArrivee, date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(0));
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
		}
	}
	...
	public void testDetermineArriveeHorsSuisseEtDepartHorsSuissePuisAchatImmeubleDansLAnnee() throws Exception {
		...
		// 2007
		{
			...
			assertPeriodeImposition(dateArrivee, dateDepart, TypeContribuableDI.VAUDOIS_ORDINAIRE_VAUD_TAX, TypeAdresseRetour.CEDI, false, false, list.get(0));
			...
			assertPeriodeImposition(dateAchat, date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
		}
		...
		// 2000-2008
		{
			...
			assertPeriodeImposition(dateArrivee, dateDepart, TypeContribuableDI.VAUDOIS_ORDINAIRE_VAUD_TAX, TypeAdresseRetour.CEDI, false, false, list.get(0));
			assertPeriodeImposition(dateAchat, date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(2));
		}
	}
	...
	public void testDetermineDepartHorsSuisseDansLAnneeAvecImmeuble() throws Exception {
		...
		// 2006 (vaudois ordinaire)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
		...
		// 2007 (départ hors-Suisse dans l'année)
		{
			...
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
		...
		// 2006-2008
		{
			...
			assertEquals(3, list.size());
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(1));
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(2));
		}
	}
	...
	public void testDetermineDepartHorsSuisseDepuisHorsCantonAvecImmeuble() throws Exception {
		...
		// 2006 (hors-canton)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.OID, false, false, list.get(0));
		}
		...
		// 2007 (hors-canton -> hors-Suisse)
		{
			...
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(0));
		}
		...
		// 2006-2008
		{
			...
			assertEquals(3, list.size());
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.OID, false, false, list.get(0));
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(2));
		}
	}
	...
	public void testDetermineDepartHorsSuisseDepuisHorsCantonAvecActiviteIndependante() throws Exception {
		...
		// 2006-2008
		{
			...
			assertEquals(3, list.size());
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(1));
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(2));
		}
	}
	/**
	...
	public void testDetermineDecesHorsCantonAvecImmeuble() throws Exception {
		...
		// 2007
		{
			...
			final List<PeriodeImposition> list = PeriodeImposition.determine(paul, 2007);
			assertNotNull(list);
			assertPeriodeImposition(date(2007, 1, 1), dateDeces, TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.ACI, false, true, list.get(0));
		}
	...
	public void testDetermineHorsForPrincipalFermeSansMotif() throws Exception {
		...
		assertNotNull(list);
		assertEquals(1, list.size());
		assertPeriodeImposition(date(2009, 1, 1), dateVente, TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, false, false, list.get(0));
	}
	...
	public void testDetermineSourcierPassantOrdinaire() throws Exception
	{
		...
		assertNotNull(list);
		assertEquals(1, list.size());
		assertPeriodeImposition(dateChangement, date(2008, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE_VAUD_TAX, TypeAdresseRetour.CEDI, false, false, list.get(0));
	}
	...
	public void testDetermineVaudoisDepense() throws Exception {
		...
		// 2007
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.VAUDOIS_DEPENSE, TypeAdresseRetour.OID, false, false, list.get(0));
		}
		...
		// 2008
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.VAUDOIS_DEPENSE, TypeAdresseRetour.OID, false, false, list.get(0));
		}
		...
		// 2009 (décès)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), dateDeces, TypeContribuableDI.VAUDOIS_DEPENSE, TypeAdresseRetour.ACI, false, false, list.get(0));
		}
	}
	...
	public void testDetermineDecesHorsCantonImmeuble() throws Exception {
		...
		// 2007
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.OID, false, false, list.get(0));
		}
		...
		// 2008
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.OID, false, false, list.get(0));
		}
		...
		// 2009 (décès)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), dateDeces, TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.ACI, false, true, list.get(0));
		}
	}
	...
	public void testDetermineDecesHorsSuisseImmeuble() throws Exception {
		...
		// 2007 (décès)
		{
			...
			assertPeriodeImposition(date(2007, 1, 1), dateDeces, TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.ACI, false, false, list.get(0)); // [UNIREG-1742] décès -> déclaration pas optionnelle
		}
		...
		// 2000-2008
		{
			...
			assertNotNull(list);
			assertEquals(8, list.size());
			assertPeriodeImposition(dateAchat, date(2000, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(0));
			assertPeriodeImposition(date(2001, 1, 1), date(2001, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(1));
			assertPeriodeImposition(date(2002, 1, 1), date(2002, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(2));
			assertPeriodeImposition(date(2003, 1, 1), date(2003, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(3));
			assertPeriodeImposition(date(2004, 1, 1), date(2004, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(4));
			assertPeriodeImposition(date(2005, 1, 1), date(2005, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(5));
			assertPeriodeImposition(date(2006, 1, 1), date(2006, 12, 31), TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.CEDI, true, false, list.get(6));
			assertPeriodeImposition(date(2007, 1, 1), dateDeces, TypeContribuableDI.HORS_SUISSE, TypeAdresseRetour.ACI, false, false, list.get(7));
		}
	}
	...
	public void testDetermineDecesHorsCantonActiviteIndependante() throws Exception {
		...
		// 2009 (décès)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), dateDeces, TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.ACI, false, true, list.get(0));
		}
	}
	...
	public void testDetermineDecesVaudoisOrdinaire() throws Exception {
		...
		// 2009 (décès)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), dateDeces, TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.ACI, false, false, list.get(0));
		}
	}
	...
	public void testDetermineDepartHorsCantonSourcierMixte137Al1() throws Exception {
		...
		// 2008 (départ en cours d'année)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.ACI, false, false, list.get(0));
		}
		...
		// 2009
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), date(2009, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.ACI, false, false, list.get(0));
		}
	}
	...
	public void testDetermineDepartHorsCantonSourcierMixte137Al2() throws Exception {
		...
		// 2008 (départ en cours d'année)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2008, 1, 1), dateDepart, TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, true, true, list.get(0));
		}
	...
	public void testDetermineArriveeHorsCantonSourcierMixte137Al1() throws Exception {
		...
		// 2007
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2007, 1, 1), date(2007, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.ACI, false, false, list.get(0));
		}
		...
		// 2009
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), date(2009, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
	}
	...
	public void testDetermineArriveeHorsCantonSourcierMixte137Al2() throws Exception {
		...
		// 2009
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), date(2009, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE_VAUD_TAX, TypeAdresseRetour.CEDI, false, false, list.get(0));
		}
	}
	...
	public void testDetermineVenteImmeubleHorsCanton() throws Exception {
		...
		// 2008 (vente de l'immeuble en cours d'année)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.HORS_CANTON, TypeAdresseRetour.OID, false, true, list.get(0));
		}
	...
	public void testDetermineFinActiviteHorsCanton() throws Exception {
		...
		// 2008 (fin d'activité indépendante en cours d'année)
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2008, 1, 1), date(2008, 12, 31), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, true, list.get(0));
		}
	...
	public void testDetermineDiplomateSuisse() throws Exception {
		...
		// 2008 (nomination comme diplomate en cours d'année)
		{
			...
			assertNotNull(list);
			assertEquals(2, list.size());
			assertPeriodeImposition(date(2008, 1, 1), dateNomination.getOneDayBefore(), TypeContribuableDI.VAUDOIS_ORDINAIRE, TypeAdresseRetour.CEDI, false, false, list.get(0));
			assertPeriodeImposition(dateNomination, date(2008, 12, 31), TypeContribuableDI.DIPLOMATE_SUISSE, null, false, false, list.get(1));
		}
		...
		// 2009
		{
			...
			assertNotNull(list);
			assertEquals(1, list.size());
			assertPeriodeImposition(date(2009, 1, 1), date(2009, 12, 31), TypeContribuableDI.DIPLOMATE_SUISSE, null, false, false, list.get(0));
		}
	}
