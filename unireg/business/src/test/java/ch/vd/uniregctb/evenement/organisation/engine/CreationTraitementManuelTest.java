	...
	public void testDeclenchementTraitementManuel() throws Exception {
		...
		doInNewTransactionAndSession(new TransactionCallback<Object>() {
			                             ...
			                             public Object doInTransaction(TransactionStatus status) {
				                             ...
				                             Assert.assertEquals("Création automatique impossible: Synergy SA (civil: 101202100), Lausanne (VD) (ofs:5586), forme juridique N_0224_CORPORATION_DE_DROIT_PUBLIC_ADMINISTRATION.", evt.getErreurs().iterator().next().getMessage());
				                             return null;
			                             }
		                             }
		);
