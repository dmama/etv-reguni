...
/**
 * <b>Note:</b> La plupart des tests de l'arrivée handler sont dans la class {@link ArriveeAdapterExtTest}.
 */
@SuppressWarnings({"JavaDoc"})
public class ArriveeAdapterTest extends AbstractEvenementAdapterTest {

	private static final String DB_UNIT_DATA_FILE = "ArriveeAdapterTest.xml";
