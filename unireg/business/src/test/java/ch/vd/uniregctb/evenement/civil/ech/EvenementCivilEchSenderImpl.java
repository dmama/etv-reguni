...
public class EvenementCivilEchSenderImpl implements EvenementCivilEchSender, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		esbValidator.setSources(new Resource[]{new ClassPathResource("eVD-0009-1-0.xsd"), new ClassPathResource("eVD-0004-3-0.xsd"), new ClassPathResource("eVD-0001-4-0.xsd")});
	}
