...
public abstract class SuppressionNationalite extends AnnulationPermisCOuNationaliteSuisse {
	...
	protected SuppressionNationalite(EvenementCivilEch evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
		super(evenement, context, options);
	}
