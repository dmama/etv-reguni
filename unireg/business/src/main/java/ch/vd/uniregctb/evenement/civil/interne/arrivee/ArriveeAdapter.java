...
import ch.vd.uniregctb.evenement.civil.interne.mouvement.MouvementAdapter;
 ...
 */
public class ArriveeAdapter extends MouvementAdapter {
	...
	public ArriveeAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected ArriveeAdapter(Individu individu, Individu conjoint, TypeEvenementCivil type, RegDate date, Integer numeroOfsCommuneAnnonce, Commune ancienneCommunePrincipale,
	...
	private static CommuneSimple getCommuneArrivee(ServiceInfrastructureService serviceInfra, ArriveeAdapter arrivee, ArriveeType type) throws InfrastructureException {
	...
	private static CommuneSimple getCommuneArriveeDepuisAdresse(ArriveeAdapter arrivee, ArriveeType type) {
		switch (type) {
	...
	private void validateForPrincipal(ArriveeAdapter arrivee, List<EvenementCivilExterneErreur> erreurs) {
	...
	protected final void validateArriveeAdressePrincipale(ArriveeAdapter arrivee, List<EvenementCivilExterneErreur> erreurs, List<EvenementCivilExterneErreur> warnings) {
		/*
	...
	protected static void validateArriveeAdresseSecondaire(ServiceInfrastructureService infraService, ArriveeAdapter arrivee, List<EvenementCivilExterneErreur> erreurs) {
		/*
	 ...
	 */
	protected final Pair<PersonnePhysique, PersonnePhysique> handleIndividuSeul(ArriveeAdapter arrivee, List<EvenementCivilExterneErreur> warnings) throws EvenementCivilHandlerException {
	 ...
	 */
	protected final Pair<PersonnePhysique, PersonnePhysique> handleIndividuEnMenage(ArriveeAdapter arrivee, List<EvenementCivilExterneErreur> warnings) throws EvenementCivilHandlerException {
	 ...
	 */
	private Pair<CommuneSimple, RegDate> getCommuneForSuiteArriveeCouple(ArriveeAdapter arrivee, PersonnePhysique arrivant, EnsembleTiersCouple ensemble) {
	 ...
	 */
	private void createOrUpdateForFiscalPrincipalOnCouple(final ArriveeAdapter arrivee, final PersonnePhysique arrivant,final MenageCommun menageCommun, List<EvenementCivilExterneErreur> warnings) {
	 ...
	 *
	 */
	protected static ArriveeType getArriveeType(ServiceInfrastructureService serviceInfra, ArriveeAdapter arrivee) throws EvenementCivilHandlerException {
	...
	protected MotifFor getMotifOuverture(ArriveeAdapter arrivee) {
