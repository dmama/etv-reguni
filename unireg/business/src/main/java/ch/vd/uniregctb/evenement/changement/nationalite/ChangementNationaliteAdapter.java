...
public class ChangementNationaliteAdapter extends GenericEvenementAdapter {

	private ChangementNationaliteHandler handler;

	protected ChangementNationaliteAdapter(EvenementCivilData evenement, EvenementCivilContext context, ChangementNationaliteHandler handler) throws EvenementAdapterException {
