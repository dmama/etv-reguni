...
public abstract class ObtentionPermisCOuNationaliteSuisse extends EvenementCivilInterneAvecAdresses {
	...
	protected ObtentionPermisCOuNationaliteSuisse(EvenementCivilEch evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
		super(evenement, context, options);
	}
