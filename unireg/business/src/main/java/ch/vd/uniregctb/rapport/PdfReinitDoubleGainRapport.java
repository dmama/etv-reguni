...
public class PdfReinitDoubleGainRapport extends PdfRapport {
	...
	public void write(final ReinitialiserBaremeDoubleGainResults results, String nom, String description, final Date dateGeneration, OutputStream os, StatusManager status) throws Exception {
