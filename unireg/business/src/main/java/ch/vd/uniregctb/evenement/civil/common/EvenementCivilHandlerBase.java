...
public abstract class EvenementCivilHandlerBase implements EvenementCivilHandler, InitializingBean {
	 ...
	 * @param warnings
	 */
	protected void verifierMouvementIndividu(Mouvement target, boolean regroupementObligatoire, List<EvenementCivilExterneErreur> erreurs, List<EvenementCivilExterneErreur> warnings) {
