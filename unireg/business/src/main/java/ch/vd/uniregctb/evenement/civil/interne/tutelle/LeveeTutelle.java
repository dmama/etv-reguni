...
public class LeveeTutelle extends EvenementCivilInterne {
	...
	protected LeveeTutelle(EvenementCivilExterne evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilInterneException {
