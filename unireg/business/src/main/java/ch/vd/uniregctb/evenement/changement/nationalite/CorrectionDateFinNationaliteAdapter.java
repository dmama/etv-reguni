...
public class CorrectionDateFinNationaliteAdapter extends GenericEvenementAdapter {

	private CorrectionDateFinNationaliteHandler handler;

	protected CorrectionDateFinNationaliteAdapter(EvenementCivilData evenement, EvenementCivilContext context, CorrectionDateFinNationaliteHandler handler) throws EvenementAdapterException {
