...
public class EvenementCivilRegrouperImpl implements EvenementCivilRegrouper {
	...
	public void regroupeTousEvenementsNonTraites(StatusManager status) {
		...
		regroupeEvenementsList(evenements, status);
	}

	/**
	 * Regroupe l'evt unitaire passé en paramètre
	 *
	 * @param evenements les événements à regrouper
	 * @param status un status manager (optionel, peut être nul)
	 */
	private void regroupeEvenementsList(List<EvenementCivilUnitaire> evenements, StatusManager status) {
	 ...
	 *
	 * @param id l'ID de l'evt unitaire
	 ...
	 *
	 * @param evenement l'événement unitaire à regrouper
	 * @return -1 en cas d'erreur, l'ID de l'evt regroupe sinon
	 */
	private long doRegroupeEvenement(EvenementCivilUnitaire evenement) {
	 ...
	 *
	 * @param unitaire l'événement unitaire
	 * @return un événement regroupé
	 */
	 ...
	 * @return un habitant ou <i>null</i> s'il n'existe pas
	 */
