...
public class ArriveeHandler extends EvenementCivilHandlerBase {
	 ...
	 */
	private Commune getCommuneDomicile(RegDate date, PersonnePhysique pp) throws AdressesResolutionException, InfrastructureException {
		final Commune commune;
		if (pp != null) {
			final AdresseGenerique adresseDomicile = adresseService.getAdresseFiscale(pp, TypeAdresseTiers.DOMICILE, date);
