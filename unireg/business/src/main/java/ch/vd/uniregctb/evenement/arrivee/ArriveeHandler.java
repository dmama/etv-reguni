...
public class ArriveeHandler extends EvenementCivilHandlerBase {
	...
	protected static void validateArriveeAdresseSecondaire(Arrivee arrivee, List<EvenementCivilErreur> erreurs) {
		/*
	 ...
	 *
	 */
	protected static ArriveeType getArriveeType(Arrivee arrivee) throws EvenementCivilHandlerException {
