...
public class AperiodicTaxLiabilityRequestHandlerV2 extends TaxLiabilityRequestHandler<AperiodicTaxLiabilityRequest> {
	...
	public TaxLiabilityControlResult doControl(AperiodicTaxLiabilityRequest request, @NotNull Tiers tiers) throws ControlRuleException {
		...
		return getTaxliabilityControlService().doControlOnDate(tiers, dateControle, rechercheMenageCommun, rechercheParents);
	}
}
