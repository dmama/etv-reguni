...
public class EditiqueHelperImpl implements EditiqueHelper {
	 ...
	 */
	public Destinataire remplitDestinataire(Tiers tiers, InfoEnteteDocument infoEnteteDocument) throws AdressesResolutionException {
	...
	private Destinataire remplitAdresseEnvoiDestinataire(Tiers tiers, InfoEnteteDocument infoEnteteDocument) throws AdressesResolutionException {
		final AdresseEnvoi adresseEnvoi = adresseService.getAdresseEnvoi(tiers, null);
	...
	public Destinataire remplitDestinataire(CollectiviteAdministrative collAdm, InfoEnteteDocument infoEnteteDocument) throws AdressesResolutionException {
	...
	public TypAdresse remplitPorteAdresse(Tiers tiers, InfoEnteteDocument infoEnteteDocument) throws AdressesResolutionException {
		...
		// Porte adresse
		//
		AdresseEnvoi adresseEnvoi = adresseService.getAdresseEnvoi(tiers, null);
