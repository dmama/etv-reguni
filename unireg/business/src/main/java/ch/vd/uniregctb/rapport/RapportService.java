...
public interface RapportService {
	...
	/**
	 * Génère le rapport d'exécution du batch de désappariement des établissements REE chargés à tort.
	 *
	 * @param results le résultat du batch
	 * @param status le status manager
	 * @return le rapport
	 */
	DesappariementREERapport generateRapport(DesappariementREEResults results, StatusManager status);
}
