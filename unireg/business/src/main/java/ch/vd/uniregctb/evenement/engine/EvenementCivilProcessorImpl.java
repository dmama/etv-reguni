...
public class EvenementCivilProcessorImpl implements EvenementCivilProcessor, EvenementHandlerRegistrar {
	...
	public Long traiteEvenementCivilRegroupe(final Long evenementCivilRegroupeId) {
		traiteEvenements(Arrays.asList(evenementCivilRegroupeId), true);
		return 0L;
	}
	...
	public Long recycleEvenementCivilRegroupe(final Long evenementCivilRegroupeId) {
		traiteEvenements(Arrays.asList(evenementCivilRegroupeId), false);
		return 0L;
	}
	 ...
	 *
	 * @param ids
	 *            la liste des ids des événements civils à traiter
	 */
	private void traiteEvenements(final List<Long> ids, boolean forceRecyclage) {
