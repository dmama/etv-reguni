...
public class ChangementIdentificateurAdapter extends ChangementAdapterBase {
	...
	protected ChangementIdentificateurAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
