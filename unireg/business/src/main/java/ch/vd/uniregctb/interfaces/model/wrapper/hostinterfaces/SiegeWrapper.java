 ...
 */
public class SiegeWrapper implements Siege {
	...
	public static SiegeWrapper get(ch.vd.registre.pm.model.Siege target) {
		if (target == null) {
			return null;
		}
		return new SiegeWrapper(target);
	}

	public SiegeWrapper(ch.vd.registre.pm.model.Siege target) {
