...
public class CorrectionOrigineAdapter extends GenericEvenementAdapter {
	...
	protected CorrectionOrigineAdapter(EvenementCivilData evenement, EvenementCivilContext context, CorrectionOrigineHandler handler) throws EvenementAdapterException {
