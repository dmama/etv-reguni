...
public abstract class AnnulationPermisCOuNationaliteSuisse extends EvenementCivilInterne {
	...
	protected AnnulationPermisCOuNationaliteSuisse(EvenementCivilEch evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
		super(evenement, context, options);
	}
