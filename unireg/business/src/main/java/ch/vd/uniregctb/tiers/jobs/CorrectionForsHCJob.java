...
public class CorrectionForsHCJob extends JobDefinition {
	...
	protected void doExecute(HashMap<String, Object> params) throws Exception {
		...
		final BatchTransactionTemplate<Long> t = new BatchTransactionTemplate<Long>(ids, BATCH_SIZE, Behavior.REPRISE_AUTOMATIQUE, transactionManager, statusManager, hibernateTemplate);
		t.execute(createProcessor(ids, statusManager));
		Audit.success("Traitement de correction de fors HC terminé.");
	}

	private BatchCallback<Long> createProcessor(List<Long> ids, StatusManager statusManager) {
	...
	class CorrectionForsProcessor extends BatchCallback<Long> {
