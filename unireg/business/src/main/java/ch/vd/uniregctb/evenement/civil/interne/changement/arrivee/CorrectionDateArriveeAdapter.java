...
public class CorrectionDateArriveeAdapter extends EvenementCivilInterneBase {

	protected CorrectionDateArriveeAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected CorrectionDateArriveeAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
