 ...
 */
public class DemenagementAdapter extends EvenementCivilInterneAvecAdressesBase {
	...
	protected DemenagementAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected DemenagementAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce,
