...
public class ObtentionNationaliteNonSuisse extends ObtentionNationalite {
	...
	protected ObtentionNationaliteNonSuisse(EvenementCivilExterne evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
