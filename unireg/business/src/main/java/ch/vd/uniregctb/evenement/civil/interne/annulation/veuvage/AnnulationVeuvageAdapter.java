...
public class AnnulationVeuvageAdapter extends EvenementCivilInterneBase {

	protected AnnulationVeuvageAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected AnnulationVeuvageAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
