...
public class ServiceInfrastructureCache extends AbstractServiceInfrastructureService implements UniregCacheInterface,
	...
	private static class KeyGetCantonByCommune {
		...
		public boolean equals(Object obj) {
			...
			if (noOfsCommune != other.noOfsCommune)
				return false;
			return true;
		}
	}
	...
	private static class KeyGetListeCommunes {
		...
		public boolean equals(Object obj) {
			...
			if (noOfsCanton != other.noOfsCanton)
				return false;
			return true;
		}
