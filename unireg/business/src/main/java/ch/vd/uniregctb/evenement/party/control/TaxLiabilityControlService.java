...
public interface TaxLiabilityControlService {
	 ...
	 */
	TaxLiabilityControlResult doControlOnDate(@NotNull Tiers tiers, RegDate date, boolean rechercheMenageCommun, boolean rechercheParent) throws ControlRuleException;
	 ...
	 * @throws ControlRuleException en cas de problème
	 */
	TaxLiabilityControlResult doControlOnPeriod(@NotNull Tiers tiers, int periode, boolean rechercheMenageCommun, boolean rechercheParent) throws ControlRuleException;
