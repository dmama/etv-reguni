...
public class DemandeValidationInscriptionDejaSoumise
	...
	public DemandeValidationInscriptionDejaSoumise(RegistrationRequestWithHistory request) {
		super(request);
		Assert.isTrue(request.getRegistrationRequestHistoryEntry().size() > 0,
				"Une DemandeValidationInscriptionDejaSoumise ne peut pas être construite si la RegistrationRequestWithHistory source n'a pas au moins une entrée dans son historique");
