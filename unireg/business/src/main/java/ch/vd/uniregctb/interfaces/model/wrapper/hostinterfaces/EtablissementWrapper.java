...
public class EtablissementWrapper implements Etablissement {
	...
	public static EtablissementWrapper get(ch.vd.registre.pm.model.Etablissement target) {
		if (target == null) {
			return null;
		}
		return new EtablissementWrapper(target);
	}

	private EtablissementWrapper(ch.vd.registre.pm.model.Etablissement target) {
		this.target = target;
