...
public class AnnulationArriveeAdapter extends GenericEvenementAdapter implements AnnulationArrivee {

	private AnnulationArriveeHandler handler;

	protected AnnulationArriveeAdapter(EvenementCivilData evenement, EvenementCivilContext context, AnnulationArriveeHandler handler) throws EvenementAdapterException {
