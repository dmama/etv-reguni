...
import ch.vd.uniregctb.xml.party.v1.DebtorPeriodicityBuilder;
...
public class DebtorStrategy extends PartyStrategy<Debtor> {
	...
	protected void initBase(Debtor to, Tiers from, Context context) throws ServiceException {
		...
		to.setCategory(EnumHelper.coreToXMLv1(debiteur.getCategorieImpotSource()));
		to.setCommunicationMode(EnumHelper.coreToXMLv1(debiteur.getModeCommunication()));
