...
public class IbanValidator {
	 ...
	 */
	private final void validateLength(String iban) throws IbanBadLengthException, IbanUnknownCountryException {
		// longueur < 2
		if ( iban.length() < 2)
	 ...
	 */
	private final void validateFormat(String iban) throws IbanBadFormatException {
	 ...
	 */
	private final void validatePlausability(String iban) throws IbanNonPlausibleException {
	 ...
	 */
	private final void validateClearing(String iban) throws IbanBadClearingNumberException {
		String codePays = extractCodePays(iban);
	 ...
	 * @return la position
	 */
	private final int getAlphabetPosition(char letter) {
