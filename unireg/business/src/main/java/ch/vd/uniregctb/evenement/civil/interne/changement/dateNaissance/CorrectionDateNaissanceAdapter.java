...
public class CorrectionDateNaissanceAdapter extends ChangementAdapterBase {

	protected CorrectionDateNaissanceAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	public CorrectionDateNaissanceAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
