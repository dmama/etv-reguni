...
import ch.vd.uniregctb.evenement.civil.interne.tutelle.TutelleAdapter;
 ...
 *
 */
public class AnnulationLeveeTutelleAdapter extends EvenementCivilInterneBase {

	protected AnnulationLeveeTutelleAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected AnnulationLeveeTutelleAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
