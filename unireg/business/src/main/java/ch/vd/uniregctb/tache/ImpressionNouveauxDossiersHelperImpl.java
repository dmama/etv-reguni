...
public class ImpressionNouveauxDossiersHelperImpl implements ImpressionNouveauxDossiersHelper {
	 ...
	 * @throws InfrastructureException
	 */
	private InfoEnteteDocument remplitEnteteDocument(Contribuable contribuable) throws AdressesResolutionException, InfrastructureException {
	...
	public TypFichierImpression remplitNouveauDossier(List<Contribuable> contribuables) throws EditiqueException {
		...
		int i = 0;
		Iterator<Contribuable> itContribuable = contribuables.iterator();
		while (itContribuable.hasNext()) {
			Contribuable contribuable = itContribuable.next();
