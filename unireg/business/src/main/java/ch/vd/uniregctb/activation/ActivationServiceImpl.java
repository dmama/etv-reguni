...
public class ActivationServiceImpl implements ActivationService {
	...
	public void annuleTiers(Tiers tiers, RegDate dateAnnulation) {
		...
		if (tiers instanceof Contribuable) {
			...
			Iterator<Tache> itTaches = taches.iterator();
			while (itTaches.hasNext()) {
				Tache tache = itTaches.next();
	...
	public void reactiveTiers(Tiers tiers, RegDate dateReactivation) {
		...
		Iterator<ForFiscal> itForsFiscaux = forsFiscaux.iterator();
		while (itForsFiscaux.hasNext()) {
			ForFiscal forFiscal = itForsFiscaux.next();
