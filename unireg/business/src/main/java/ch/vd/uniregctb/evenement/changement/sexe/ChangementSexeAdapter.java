...
public class ChangementSexeAdapter extends GenericEvenementAdapter {
	...
	protected ChangementSexeAdapter(EvenementCivilData evenement, EvenementCivilContext context, ChangementSexeHandler handler) throws EvenementAdapterException {
