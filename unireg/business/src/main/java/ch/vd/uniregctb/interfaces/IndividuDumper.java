...
public abstract class IndividuDumper {
	...
	private static String dumpPermis(Permis permis, int depth) {
		...
		s.append(tab(depth + 1)).append("dateDebut=").append(permis.getDateDebutValidite()).append(", \n");
		s.append(tab(depth + 1)).append("dateFin=").append(permis.getDateFinValidite()).append(", \n");
	...
	private static String dumpPermis(List<Permis> permis, int depth) {
		if (permis == null) {
			return "null";
		}
	...
	private static String dumpEtatCivil(EtatCivil etatCivil, int depth) {
		...
		StringBuilder s = new StringBuilder();
		s.append("EtatCivil{\n");
		s.append(tab(depth + 1)).append("dateDebut=").append(etatCivil.getDateDebutValidite()).append(", \n");
		s.append(tab(depth + 1)).append("type=").append(etatCivil.getTypeEtatCivil()).append(", \n");
		s.append(tab(depth + 1)).append("numeroConjoint=").append(etatCivil.getNumeroConjoint()).append(", \n");
		s.append(tab(depth)).append("}");
