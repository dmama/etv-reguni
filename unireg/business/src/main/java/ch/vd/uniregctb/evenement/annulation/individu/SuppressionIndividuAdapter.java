...
public class SuppressionIndividuAdapter extends GenericEvenementAdapter {

	protected SuppressionIndividuAdapter(EvenementCivilData evenement, EvenementCivilContext context) throws EvenementAdapterException {
