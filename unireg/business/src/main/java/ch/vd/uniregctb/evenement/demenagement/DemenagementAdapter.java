 ...
 */
public class DemenagementAdapter extends GenericEvenementAdapter implements Demenagement {
	...
	public void init(EvenementCivilRegroupe evenementCivilRegroupe, ServiceCivilService serviceCivil, ServiceInfrastructureService infrastructureService) throws EvenementAdapterException {
		...
		final AdressesCiviles adresses = serviceCivil.getAdresses(super.getIndividu().getNoTechnique(), evenementCivilRegroupe.getDateEvenement().getOneDayBefore());
