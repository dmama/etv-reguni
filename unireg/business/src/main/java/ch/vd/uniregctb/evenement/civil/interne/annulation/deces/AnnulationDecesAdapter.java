 ...
 */
public class AnnulationDecesAdapter extends EvenementCivilInterneBase {
	...
	protected AnnulationDecesAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected AnnulationDecesAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
	 ...
	 */
	@SuppressWarnings({"JavaDoc"})
	protected AnnulationDecesAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
