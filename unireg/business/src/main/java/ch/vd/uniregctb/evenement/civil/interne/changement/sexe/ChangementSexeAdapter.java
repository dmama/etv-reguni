...
public class ChangementSexeAdapter extends ChangementAdapterBase {
	...
	protected ChangementSexeAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected ChangementSexeAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
