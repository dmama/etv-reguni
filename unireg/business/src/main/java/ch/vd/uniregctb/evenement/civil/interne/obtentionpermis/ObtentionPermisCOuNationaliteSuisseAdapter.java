 ...
 *
 */
public abstract class ObtentionPermisCOuNationaliteSuisseAdapter extends EvenementCivilInterneAvecAdressesBase {

	protected ObtentionPermisCOuNationaliteSuisseAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected ObtentionPermisCOuNationaliteSuisseAdapter(Individu individu, Individu conjoint, TypeEvenementCivil typeEvenementCivil, RegDate dateEvenement, Integer numeroOfsCommuneAnnonce,
	...
	public Pair<PersonnePhysique,PersonnePhysique> handle(List<EvenementCivilExterneErreur> warnings) throws EvenementCivilHandlerException {
		...
		if (forPrincipalHabitant != null) { //individu seul assujetti
			...
			int noOfsEtendu = 0;
			if(this instanceof ObtentionNationaliteAdapter){
				noOfsEtendu = ((ObtentionNationaliteAdapter) this).getNumeroOfsEtenduCommunePrincipale();
			}
			else if(this instanceof ObtentionPermisAdapter){
				noOfsEtendu = ((ObtentionPermisAdapter) this).getNumeroOfsEtenduCommunePrincipale();
			}
