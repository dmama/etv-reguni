 ...
 */
public class ToFondeeTransitionEtatEntreprise extends BaseTransitionEtatEntreprise {
	public final TypeEtatEntreprise TARGET_TYPE = TypeEtatEntreprise.FONDEE;

	public ToFondeeTransitionEtatEntreprise(TiersDAO tiersDAO, Entreprise entreprise, RegDate date, TypeGenerationEtatEntreprise generation) {
