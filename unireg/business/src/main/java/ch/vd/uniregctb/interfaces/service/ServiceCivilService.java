...
public interface ServiceCivilService {
	 ...
	 *
	 * @param noIndividu
	 *            l'individu dont on recherche les adresses.
	 * @param date
	 ...
	 */
	AdressesCiviles getAdresses(long noIndividu, RegDate date);
	 ...
	 */
	AdressesCivilesHisto getAdressesHisto(long noIndividu);
	 ...
	 * <p>
	 * La liste retournée par ce service peut être vide, signifiant l'absence de données d'un point de vue métier pour les paramêtres
	 * donnés.
	 *
	 * @param noIndividu
	 *            le numéro technique de l'individu.
	 * @param annee
	 *            l'année de validité.
	 ...
	 * <p>
	 * Ce service renseigne, pour chaque objet du graphe retourné, l'ensemble des attributs mono-valués ainsi que les attributs muti-valués
	 * suivants :
	 * <li>La liste des historiques de l'individu.</li>
	 * <li>La liste des états civils de l'individu.</li>
	 * <p>
	 * L'objet retourné par ce service peut être <code>null</code>, signifiant l'absence de données d'un point de vue métier pour les
	 * paramêtres donnés.
	 *
	 * @param noIndividu
	 *            le numéro technique de l'individu.
	 ...
	 *
	 * @param nosIndividus
	 *            les numéros d'individus demandés
	 * @param date
	 *            la date de validité des individus
	 * @param parties
	 *            les parties optionnelles devant être renseignées
	 ...
	 * Ce service renseigne, pour chaque objet du graphe retourné, l'ensemble des attributs mono-valués.
	 * <p>
	 * La liste retournée par ce service peut être vide, signifiant l'absence de données d'un point de vue métier pour les paramètres
	 * donnés.
	 *
	 * @param noIndividu
	 *            le numéro technique de l'individu.
	...
	/**
	 * Retourne la tutelle, valide durant l'année en paramètre, à laquelle l'individu attendu est soumis, l'individu attendu étant identifié
	 * par le numéro en paramètre.
	 * <p>
	 * Ce service renseigne, pour chaque objet du graphe retourné, l'ensemble des attributs mono-valués.
	 * <p>
	 * L'objet retourné par ce service peut être <code>null</code>, signifiant l'absence de données d'un point de vue métier pour les
	...
	/**
	 * @return <b>vrai</b> si l'implémentation courante du service civil possède un cache et que ce cache est susceptible d'être chauffé
	 ...
	 * <p>
	 * Note: cette méthode n'a aucun effet sur la plupart des implémentations des services civils. Seul l'implémentation de caching peut en
	 * faire quelque chose.
	 *
	 * @param individus
	 *            les individus à stocker dans le cache du service civil.
	 * @param date
	 *            la date de validité des individus spécifiés.
	 * @param parties
	 *            les parties renseignées sur les individus
	 */
