 ...
 *
 */
public class AnnulationReconciliationAdapter extends EvenementCivilInterneBase {

	protected AnnulationReconciliationAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected AnnulationReconciliationAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
