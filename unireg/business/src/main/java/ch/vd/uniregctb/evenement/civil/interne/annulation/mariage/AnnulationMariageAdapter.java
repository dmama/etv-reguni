 ...
 *
 */
public class AnnulationMariageAdapter extends EvenementCivilInterneBase {

	protected AnnulationMariageAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected AnnulationMariageAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
