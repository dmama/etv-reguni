...
public class EvenementCivilListener extends EsbMessageEndpointListener implements ErrorMonitorableMessageListener {
	...
	protected boolean onEvenementCivil(String message) throws EvenementCivilException {
		...
		final EvenementCivilRegPP evenement = extractEvenement(message);
		if (evenement == null) {
	...
	private EvenementCivilRegPP extractEvenement(String xmlMessage) throws EvenementCivilException {
		...
		final EvenementCivilRegPP evenement = new EvenementCivilRegPP(bean);
	...
	private boolean insertEvenement(final EvenementCivilRegPP evenement) {
