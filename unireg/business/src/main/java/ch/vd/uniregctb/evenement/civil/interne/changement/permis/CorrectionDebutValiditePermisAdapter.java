...
public class CorrectionDebutValiditePermisAdapter extends EvenementCivilInterneBase {
	...
	protected CorrectionDebutValiditePermisAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected CorrectionDebutValiditePermisAdapter(Individu individu, Long principalPPId, Individu conjoint, Long conjointPPId, RegDate date, Integer numeroOfsCommuneAnnonce,
