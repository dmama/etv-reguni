...
public class AnnulationLeveeTutelle extends EvenementCivilInterne {
	...
	protected AnnulationLeveeTutelle(EvenementCivilRegPP evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
