...
public class AnnulationLeveeTutelle extends EvenementCivilInterne {
	...
	protected AnnulationLeveeTutelle(EvenementCivilExterne evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilInterneException {
