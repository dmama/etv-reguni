...
public class RelationBetweenPartiesBuilder {
	 ...
	 * @return un objet {@link ch.vd.unireg.xml.party.relation.v1.RelationBetweenParties}, ou <code>null</code> si l'une des personnes physiques du rapport de filiation est inconnue
	 */
	@Nullable
