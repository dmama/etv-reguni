...
public class DepartSecondaireEch extends DepartSecondaire {

	private static final String IGNORE = "Ignoré car départ secondaire vaudois";
	...
	public DepartSecondaireEch(EvenementCivilEch event, EvenementCivilContext context, EvenementCivilOptions options, Adresse ancienneAdresse) throws EvenementCivilException {
		super(event, context, options, ancienneAdresse);

		// SIFISC-4912 Pour les événements ech, les départs secondaires vaudois sont ignorés
		if (isDepartVaudois()) {
