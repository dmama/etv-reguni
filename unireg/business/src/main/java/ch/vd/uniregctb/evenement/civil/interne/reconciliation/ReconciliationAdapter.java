...
public class ReconciliationAdapter extends EvenementCivilInterneBase {

	private static final Logger LOGGER = Logger.getLogger(ReconciliationAdapter.class);

	protected ReconciliationAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected ReconciliationAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, EvenementCivilContext context) {
