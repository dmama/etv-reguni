...
public interface TiersService {
	...
	/**
	 * Renvoie le debiteur de prestation imposable correspondant au numéro donné.
	 *
	 * @param numeroDPI
	 *            le numero u DPI
	 * @return le DEbiteur de prestation imposable correspondant correspondant
	 */
	...
	/**
	 * Recupere l'individu correspondant a l'habitant pour une annee donnee
	 *
	 * @param habitant
	 * @param annee
	 * @param attributes
	...
	/**
	 * Recupere le Tiers sourcier avec l'ancien numéro de sourcier.
	 *
	 * @param int noSourcier
	 * @return Tiers
	 */
	...
	/**
	 * TODO (GDY) dire ce que fait cette méthode.
	 */
	...
	/**
	 * Retourne une chaîne de caractères comme "Non assujetti", "Imposition ordinaire VD/HS/HC", "Dépense"...
	 * qui décrit le type d'assujettissement du tiers donné à la date donnée
	 *
	 * @param tiers
	 * @param date
	 ...
	 *
	 * @param ctbIds
	 *            les numéros des contribuables
	 * @param dateLimite
	 *            la date limite d'exclusion (voir {@link Contribuable#getDateLimiteExclusionEnvoiDeclarationImpot()})
	 */
