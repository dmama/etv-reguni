 ...
 */
public class ToDissouteTransitionEtatEntreprise extends BaseTransitionEtatEntreprise {
	public final TypeEtatEntreprise TARGET_TYPE = TypeEtatEntreprise.DISSOUTE;
