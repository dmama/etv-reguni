...
public class ModificationAdresseNotificationTranslationStrategy extends AbstractChangementTranslationStrategy {
	...
	public EvenementCivilInterne create(EvenementCivilExterne event, EvenementCivilContext context) throws EvenementCivilException {
		return new ModificationAdresseNotification(event, context);
	}
