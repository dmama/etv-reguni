 ...
 * </ul>
 */
public class DepartAdapter extends MouvementAdapter {
	...
	protected DepartAdapter(EvenementCivilExterne evenement, EvenementCivilContext context) throws EvenementCivilInterneException {
	...
	protected DepartAdapter(Individu individu, Individu conjoint, RegDate date, Integer numeroOfsCommuneAnnonce, Commune ancienneCommunePrincipale, Commune nouvelleCommunePrincipale,
	 ...
	 */
	private void traiteHabitantOfAncienDepart(final DepartAdapter depart, final PersonnePhysique pp) {
	 ...
	 */
	private boolean isDepartComplet(DepartAdapter depart) {
	 ...
	 */
	private Contribuable findContribuable(DepartAdapter depart, PersonnePhysique pp, boolean demenagementVD) {
	 ...
	 */
	private RegDate findDateFermeture(DepartAdapter depart, boolean demenagementVD) {
	 ...
	 */
	private MotifFor findMotifFermeture(DepartAdapter depart) {
	...
	protected final void validateDepartAdressePrincipale(DepartAdapter depart, List<EvenementCivilExterneErreur> erreurs) {
	...
	protected final void validateDepartAdresseSecondaire(DepartAdapter depart, List<EvenementCivilExterneErreur> erreurs) {
	 ...
	 * @param erreurs
	 */
	public void validateCoherenceAdresse(Adresse adresse, CommuneSimple commune, DepartAdapter depart, List<EvenementCivilExterneErreur> erreurs) {
	 ...
	 */
	private void handleDepartResidencePrincipale(DepartAdapter depart, Contribuable contribuable, RegDate dateFermeture, MotifFor motifFermeture, int numeroOfsAutoriteFiscale) {
	 ...
	 * @param motifFermeture
	 */
	private void handleDepartResidenceSecondaire(DepartAdapter depart, Contribuable contribuable, RegDate dateFermeture, MotifFor motifFermeture) {
	...
	private static boolean isPaysInconnu(DepartAdapter depart) {
