 ...
 */
public class DepartAdapter extends EvenementCivilInterneAvecAdressesBase implements Depart {
	...
	protected DepartAdapter(EvenementCivilExterne evenement, EvenementCivilContext context, DepartHandler handler) throws EvenementCivilInterneException {
	...
	/**
	 * @see ch.vd.uniregctb.evenement.civil.interne.depart.Depart#getNouvelleAdresseCourrier()
	 */
	...
	/**
	 * @see ch.vd.uniregctb.evenement.civil.interne.depart.Depart#getNouvelleAdressePrincipale()
	 */
