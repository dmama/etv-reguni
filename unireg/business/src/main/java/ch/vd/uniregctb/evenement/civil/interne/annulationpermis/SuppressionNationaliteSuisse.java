...
public class SuppressionNationaliteSuisse extends SuppressionNationalite {
	...
	protected SuppressionNationaliteSuisse(EvenementCivilExterne evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
