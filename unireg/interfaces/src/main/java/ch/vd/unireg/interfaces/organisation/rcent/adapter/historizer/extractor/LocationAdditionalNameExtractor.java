...
public class LocationAdditionalNameExtractor implements Function<Organisation, Stream<Keyed<BigInteger, String>>> {
	@Override
	public Stream<Keyed<BigInteger, String>> apply(Organisation org) {
		return org.getOrganisationLocation().stream()
				.filter(ol -> ol.getAdditionalName() != null)
				.map(ol -> new Keyed<>(ol.getCantonalId(), ol.getAdditionalName()));
	}
}
