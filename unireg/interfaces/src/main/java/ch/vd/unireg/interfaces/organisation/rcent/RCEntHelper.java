...
public class RCEntHelper {
	 ...
	 * @param rcEntList Une liste de DateRanged RCEnt.
	 ...
	 */
	public static <U> List<DateRanged<U>> convert(List<ch.vd.uniregctb.adapter.rcent.historizer.container.DateRanged<U>> rcEntList) {
		List<DateRanged<U>> drList = new ArrayList<>(rcEntList.size());
		for (ch.vd.uniregctb.adapter.rcent.historizer.container.DateRanged<U> dr : rcEntList) {
