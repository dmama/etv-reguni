...
public class CapitalConverter extends RangedToRangeBaseConverter<ch.vd.evd0022.v1.Capital, Capital> {

	private static final TypeOfCapitalConverter TYPE_OF_CAPITAL_CONVERTER = new TypeOfCapitalConverter();

	@NotNull
	@Override
	protected Capital convert(@NotNull DateRangeHelper.Ranged<ch.vd.evd0022.v1.Capital> range) {
		final ch.vd.evd0022.v1.Capital capital = range.getPayload();
