...
public class ServiceOrganisationCacheTest {
	...
	public void setup() throws Exception {
		...
		cache.setDataEventService(new DataEventService() {
			@Override
	...
	public void testCallTwiceHitServiceOnce() {
		...
		LOGGER.info(String.format("Target called once, return organisation %d.", id));
		organisation = cache.getOrganisationHistory(id);
		LOGGER.info(String.format("Target called a second time, return organisation %d.", id));
