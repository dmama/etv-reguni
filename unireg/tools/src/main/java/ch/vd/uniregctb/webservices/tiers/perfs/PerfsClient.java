...
public class PerfsClient {
	...
	private final PerfsThread.Query query;
	...
	public static void main(String[] args) {
		...
		try {
			...
			final PerfsThread.Query query;
			if (dateAsString != null) {
				Date date = parseDate(dateAsString);
				query = new PerfsThread.DateQuery(date, operateur, oid);
			}
			else if (periodeAsString != null) {
				int annee = Integer.valueOf(periodeAsString);
				query = new PerfsThread.PeriodeQuery(annee, operateur, oid);
			}
			else {
				query = new PerfsThread.HistoQuery(operateur, oid);
			}
	...
	public PerfsClient(String serviceUrl, String username, String password, PerfsThread.Query query, Integer queriesCount, int threadCount, long ctbId) throws Exception {
	...
	public PerfsClient(String serviceUrl, String username, String password, PerfsThread.Query query, Integer queriesCount, int threadCount,
