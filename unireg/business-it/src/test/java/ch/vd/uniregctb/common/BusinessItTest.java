...
@ContextConfiguration(locations = {
		...
		TestingConstants.UNIREG_BUSINESSIT_CACHE,
		TestingConstants.UNIREG_BUSINESSIT_DATABASE,
		TestingConstants.UNIREG_BUSINESSIT_INTERFACES,
		TestingConstants.UNIREG_BUSINESSIT_CLIENT_WEBSERVICE
})
