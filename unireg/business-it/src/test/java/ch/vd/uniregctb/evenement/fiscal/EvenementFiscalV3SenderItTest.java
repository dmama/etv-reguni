...
public class EvenementFiscalV3SenderItTest extends EvenementTest {
	...
	public void testSendEvenementSituationFamille() throws Exception {
		...
		try {
			...
			final String texte = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><ev-fiscal-3:evenementFiscal xmlns:ev-fiscal-3=\"http://www.vd.ch/fiscalite/unireg/event/fiscal/3\" xmlns:common-2=\"http://www.vd.ch/fiscalite/unireg/common/2\" xmlns:corp-4=\"http://www.vd.ch/fiscalite/unireg/party/corporation/4\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"ev-fiscal-3:changementSituationFamilleType\"><ev-fiscal-3:categorieTiers>PP</ev-fiscal-3:categorieTiers><ev-fiscal-3:numeroTiers>12300002</ev-fiscal-3:numeroTiers><ev-fiscal-3:date><common-2:year>2009</common-2:year><common-2:month>12</common-2:month><common-2:day>9</common-2:day></ev-fiscal-3:date></ev-fiscal-3:evenementFiscal>";
	...
	public void testSendEvenementFor() throws Exception {
		...
		try {
			...
			// On vérifie que l'on a bien envoyé le message
			final String texte = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><ev-fiscal-3:evenementFiscal xmlns:ev-fiscal-3=\"http://www.vd.ch/fiscalite/unireg/event/fiscal/3\" xmlns:common-2=\"http://www.vd.ch/fiscalite/unireg/common/2\" xmlns:corp-4=\"http://www.vd.ch/fiscalite/unireg/party/corporation/4\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:type=\"ev-fiscal-3:ouvertureForType\"><ev-fiscal-3:categorieTiers>PP</ev-fiscal-3:categorieTiers><ev-fiscal-3:numeroTiers>12300002</ev-fiscal-3:numeroTiers><ev-fiscal-3:date><common-2:year>2009</common-2:year><common-2:month>12</common-2:month><common-2:day>9</common-2:day></ev-fiscal-3:date><ev-fiscal-3:forPrincipal>true</ev-fiscal-3:forPrincipal><ev-fiscal-3:localisationFor>VAUD_MUNICIPALITY</ev-fiscal-3:localisationFor><ev-fiscal-3:motifOuverture>MOVE_IN_FROM_FOREIGN_COUNTRY</ev-fiscal-3:motifOuverture><ev-fiscal-3:padding>0</ev-fiscal-3:padding></ev-fiscal-3:evenementFiscal>";
			assertTextMessage(OUTPUT_QUEUE, texte);
		}
		finally {
			AuthenticationHelper.popPrincipal();
