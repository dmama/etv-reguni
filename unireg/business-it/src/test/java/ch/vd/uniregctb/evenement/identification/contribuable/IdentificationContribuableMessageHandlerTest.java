...
public class IdentificationContribuableMessageHandlerTest {
...
// msi (01.10.2009) : fonctionne pas en développement pour une raison inconnue		jmsConnectionManager.setBrokerURL("tcp://grominet:4500");
	...
	public void testReceiveDemandeIdentificationCtb() throws Exception {
		...
		assertEquals("IdentificationContribuableTest", header.getBusinessUser());
	 ...
	 */
	private Date newUtilDate(int year, int month, int day) {
	...
	private void assertTextMessage(String queueName, final String texte) throws Exception {
	...
	private void sendTexteMessage(String queueName, String texte) throws Exception {

		EsbMessage m = new EsbMessage();
		m.setBusinessUser("IdentificationContribuableTest");
