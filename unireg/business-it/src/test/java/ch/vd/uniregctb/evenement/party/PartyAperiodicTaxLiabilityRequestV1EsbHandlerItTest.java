 ...
 */
public class PartyAperiodicTaxLiabilityRequestV1EsbHandlerItTest extends PartyRequestEsbHandlerItTest {

	private AperiodicTaxLiabilityRequestHandler handler;

	@Override
	public void onSetUp() throws Exception {
		handler = getBean(AperiodicTaxLiabilityRequestHandler.class, "aperiodicTaxLiabilityRequestHandlerV1");
		super.onSetUp();
	}
