 ...
 */
public class RegistreTestContextManager {
	 ...
	 */
	static final ContextCache contextCache = new RegistreContextCache();
	 ...
	 */
	public RegistreTestContextManager(Class<?> testClass) {
