...
public class MotifForTest extends EnumTest {
	...
	public void testFromValue() {
		...
		assertEquals(MotifFor.MARIAGE_ENREGISTREMENT_PARTENARIAT_RECONCILIATION, EnumHelper
				.coreToWeb(ch.vd.uniregctb.type.MotifFor.MARIAGE_ENREGISTREMENT_PARTENARIAT_RECONCILIATION));
		assertEquals(MotifFor.SEPARATION_DIVORCE_DISSOLUTION_PARTENARIAT, EnumHelper
				.coreToWeb(ch.vd.uniregctb.type.MotifFor.SEPARATION_DIVORCE_DISSOLUTION_PARTENARIAT));
