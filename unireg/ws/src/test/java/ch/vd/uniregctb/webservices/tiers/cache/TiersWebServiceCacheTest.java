...
public class TiersWebServiceCacheTest extends WebserviceTest {
	...
	public void onSetUp() throws Exception {
		...
		TiersWebService target = getBean(TiersWebService.class, "tiersServiceBean");

		service = new TiersWebServiceCache();
		service.setCacheManager(manager);
		service.setTarget(target);
		service.setCacheName("webServiceTiers");
		cache = service.getEhCache();

		wsCacheManager = getBean(TiersWebServiceCacheManager.class, "tiersServiceCacheManager");
	...
	public void onTearDown() throws Exception {
		wsCacheManager.setCache(getBean(TiersWebServiceCache.class, "tiersServiceCache"));
		super.onTearDown();
	}
	...
	private static void assertOnlyPart(TiersPart p, Tiers tiers) {
		...
		assertNullOrNotNull(checkForsFiscaux, tiers.forFiscalPrincipal, "forFiscalPrincipal");
		assertNullOrNotNull(checkForsFiscaux, tiers.autresForsFiscaux, "autresForsFiscaux");
		...
		if (tiers instanceof Contribuable) {
			...
			assertNullOrNotNull(checkAssujettissement, ctb.assujettissement, "assujettissement");
	...
	private static void assertOnlyPart(TiersPart p, TiersHisto tiers) {
		...
		assertNullOrNotNull(checkAdressesEnvoi, tiers.adresseEnvoi, "adresseEnvoi");
		assertNullOrNotNull(checkForsFiscaux, tiers.forsFiscauxPrincipaux, "forsFiscauxPrincipaux");
		assertNullOrNotNull(checkForsFiscaux, tiers.autresForsFiscaux, "autresForsFiscaux");
		...
		if (tiers instanceof ContribuableHisto) {
			...
			assertNullOrNotNull(checkAssujettissement, ctb.assujettissements, "assujettissements");
