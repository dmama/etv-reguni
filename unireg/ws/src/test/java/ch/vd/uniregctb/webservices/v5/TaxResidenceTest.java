...
public class TaxResidenceTest extends EnumTest {
	...
	public void testRattachementFromValue() {
		...
		assertEquals(TaxLiabilityReason.PROFIT_SHARING_FOREIGN_COUNTRY_TAXPAYER, EnumHelper.coreToWeb(ch.vd.uniregctb.type.MotifRattachement.PARTICIPATIONS_HORS_SUISSE));
		assertEquals(TaxLiabilityReason.WINE_FARM_SEASONAL_WORKER, EnumHelper.coreToWeb(ch.vd.uniregctb.type.MotifRattachement.EFFEUILLEUSES));
	}
