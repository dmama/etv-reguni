...
public class ForFiscalTest extends EnumTest {
	...
	public void testGenreImpotFromValue() {
		...
		assertNull(EnumHelper.coreToWeb(ch.vd.uniregctb.type.GenreImpot.BENEFICE_CAPITAL));
	}
	...
	public void testRattachementFromValue() {
		...
		assertNull(EnumHelper.coreToWeb(ch.vd.uniregctb.type.MotifRattachement.ETABLISSEMENT_STABLE));
	}
