...
public class DataHelper {
	...
	public static ch.vd.unireg.xml.party.v2.PartyPart webToXML(PartyPart part) {
		if (part == null) {
			return null;
		}
		switch (part) {
		case ADDRESSES:
			return ch.vd.unireg.xml.party.v2.PartyPart.ADDRESSES;
		case BANK_ACCOUNTS:
			return ch.vd.unireg.xml.party.v2.PartyPart.BANK_ACCOUNTS;
		case CAPITALS:
			return ch.vd.unireg.xml.party.v2.PartyPart.CAPITALS;
		case CHILDREN:
			return ch.vd.unireg.xml.party.v2.PartyPart.CHILDREN;
		case CORPORATION_STATUSES:
			return ch.vd.unireg.xml.party.v2.PartyPart.CORPORATION_STATUSES;
		case DEBTOR_PERIODICITIES:
			return ch.vd.unireg.xml.party.v2.PartyPart.DEBTOR_PERIODICITIES;
		case FAMILY_STATUSES:
			return ch.vd.unireg.xml.party.v2.PartyPart.FAMILY_STATUSES;
		case HOUSEHOLD_MEMBERS:
			return ch.vd.unireg.xml.party.v2.PartyPart.HOUSEHOLD_MEMBERS;
		case IMMOVABLE_PROPERTIES:
			return ch.vd.unireg.xml.party.v2.PartyPart.IMMOVABLE_PROPERTIES;
		case LEGAL_FORMS:
			return ch.vd.unireg.xml.party.v2.PartyPart.LEGAL_FORMS;
		case LEGAL_SEATS:
			return ch.vd.unireg.xml.party.v2.PartyPart.LEGAL_SEATS;
		case MANAGING_TAX_RESIDENCES:
			return ch.vd.unireg.xml.party.v2.PartyPart.MANAGING_TAX_RESIDENCES;
		case PARENTS:
			return ch.vd.unireg.xml.party.v2.PartyPart.PARENTS;
		case RELATIONS_BETWEEN_PARTIES:
			return ch.vd.unireg.xml.party.v2.PartyPart.RELATIONS_BETWEEN_PARTIES;
		case SIMPLIFIED_TAX_LIABILITIES:
			return ch.vd.unireg.xml.party.v2.PartyPart.SIMPLIFIED_TAX_LIABILITIES;
		case TAX_DECLARATIONS:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAX_DECLARATIONS;
		case TAX_DECLARATIONS_STATUSES:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAX_DECLARATIONS_STATUSES;
		case TAX_DECLARATIONS_DEADLINES:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAX_DECLARATIONS_DEADLINES;
		case TAX_LIABILITIES:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAX_LIABILITIES;
		case TAX_RESIDENCES:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAX_RESIDENCES;
		case TAX_SYSTEMS:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAX_SYSTEMS;
		case TAXATION_PERIODS:
			return ch.vd.unireg.xml.party.v2.PartyPart.TAXATION_PERIODS;
		case VIRTUAL_TAX_RESIDENCES:
			return ch.vd.unireg.xml.party.v2.PartyPart.VIRTUAL_TAX_RESIDENCES;
		default:
