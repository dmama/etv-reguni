...
create table IMMEUBLE (id number(19,0) not null, ANNULATION_DATE timestamp, ANNULATION_USER nvarchar2(65), LOG_CDATE timestamp, LOG_CUSER nvarchar2(65), LOG_MDATE timestamp, LOG_MUSER nvarchar2(65), ANCIENNE_ESTIM_FISC number(10,0), DATE_DEBUT number(10,0) not null, DATE_ESTIM_FISC number(10,0), DATE_FIN number(10,0), ESTIMATION_FISCALE number(10,0) not null, GENRE_PROPRIETE nvarchar2(12) not null, NATURE_IMMEUBLE nvarchar2(255) not null, NUMERO_IMMEUBLE nvarchar2(20) not null, PART_PROPRIETE_DENOMINATEUR number(10,0) not null, PART_PROPRIETE_NUMERATEUR number(10,0) not null, CTB_ID number(19,0) not null, primary key (id));
