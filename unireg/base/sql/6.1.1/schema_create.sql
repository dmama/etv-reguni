...
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('6.1.1', 'create');
...
create table MODELE_FEUILLE_DOC (id number(19,0) not null, ANNULATION_DATE timestamp, ANNULATION_USER nvarchar2(65), LOG_CDATE timestamp, LOG_CUSER nvarchar2(65), LOG_MDATE timestamp, LOG_MUSER nvarchar2(65), SORT_INDEX number(10,0), INTITULE_FEUILLE nvarchar2(255), NO_CADEV number(4,0) not null, NO_FORMULAIRE_ACI number(5,0), MODELE_ID number(19,0), primary key (id));
...
create table PARAMETRE_PERIODE_FISCALE (PPF_TYPE nvarchar2(5) not null, id number(19,0) not null, ANNULATION_DATE timestamp, ANNULATION_USER nvarchar2(65), LOG_CDATE timestamp, LOG_CUSER nvarchar2(65), LOG_MDATE timestamp, LOG_MUSER nvarchar2(65), DATE_FIN_ENVOI_MASSE number(10,0), TERME_GEN_SOMM_EFFECT number(10,0), TERME_GEN_SOMM_REGL number(10,0), TYPE_CTB nvarchar2(17), PERIODE_ID number(19,0), PM_DELAI_IMPRIME_MOIS NUMBER(10,0), PM_TOLERANCE_JOURS NUMBER(10,0), PM_DELAI_IMPRIME_FIN_MOIS NUMBER(1,0), PM_TOLERANCE_FIN_MOIS NUMBER(1,0), PM_REF_DELAI NVARCHAR2(12), SNC_RAPPEL_IMPRIME NUMBER(10,0), SNC_RAPPEL_EFFECTIF NUMBER(10,0), primary key (id));
