...
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('6.0.0', 'create');
...
create table EVENEMENT_ORGANISATION (id number(19,0) not null, ANNULATION_DATE timestamp, ANNULATION_USER nvarchar2(65), LOG_CDATE timestamp, LOG_CUSER nvarchar2(65), LOG_MDATE timestamp, LOG_MUSER nvarchar2(65), IDENT_EMETTEUR nvarchar2(5), REFDATA_EMETTEUR nvarchar2(255), COMMENTAIRE_TRAITEMENT nvarchar2(255), DATE_EVENEMENT number(10,0) not null, DATE_TRAITEMENT timestamp, ETAT nvarchar2(10) not null, NO_ORGANISATION number(19,0), TYPE nvarchar2(40) not null, primary key (id));
