...
CREATE TABLE RF_SURFACE_BATIMENT
(
	ID NUMBER(19) PRIMARY KEY NOT NULL,
	ANNULATION_DATE TIMESTAMP(6),
	ANNULATION_USER NVARCHAR2(65),
...
ALTER TABLE RF_SURFACE_BATIMENT ADD FOREIGN KEY (BATIMENT_ID) REFERENCES RF_BATIMENT (ID);
CREATE INDEX IDX_SURF_BAT_RF_BATIMENT_ID ON RF_SURFACE_BATIMENT (BATIMENT_ID);
