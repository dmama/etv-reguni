...
INSERT INTO ETIQUETTE (ID, LOG_CDATE, LOG_CUSER, LOG_MDATE, LOG_MUSER, CODE, LIBELLE, TYPE_TIERS, COLADM_ID, ACTIVE, AUTO_DECES)
    SELECT HIBERNATE_SEQUENCE.NEXTVAL, CURRENT_DATE, 'Installation 17R1', CURRENT_DATE, 'Installation 17R1', 'HERITAGE', 'Héritage', 'PP', CA.NUMERO, 1, 'BD:Decalage{+1D};ED:DecalageAvecCorrection{+2Y/EOY}'
