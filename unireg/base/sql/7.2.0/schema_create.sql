...
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('7.2.0', 'create');
...
CREATE TABLE EVENEMENT_FISCAL (
	...
	TYPE_EVT_SERVITUDE NVARCHAR2(16),
	TIERS_RF_ID NUMBER(19)
		constraint FK_EVTFISC_TIERS_RF_ID
	...
	AYANT_DROIT_ID NUMBER(19)
		constraint FK_EVTFISC_AYANTDROIT_ID
		references RF_AYANT_DROIT,
