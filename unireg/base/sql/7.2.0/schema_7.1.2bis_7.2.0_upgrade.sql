...
ALTER TABLE EVENEMENT_FISCAL ADD TYPE_EVT_SERVITUDE NVARCHAR2(16);
ALTER TABLE EVENEMENT_FISCAL ADD TIERS_RF_ID NUMBER(19) constraint FK_EVTFISC_TIERS_RF_ID references RF_AYANT_DROIT;
ALTER TABLE EVENEMENT_FISCAL ADD BATIMENT_ID NUMBER(19) constraint FK_EVTFISC_BATIMENT_ID references RF_BATIMENT;
ALTER TABLE EVENEMENT_FISCAL ADD AYANT_DROIT_ID NUMBER(19) constraint FK_EVTFISC_AYANTDROIT_ID references RF_AYANT_DROIT;
ALTER TABLE EVENEMENT_FISCAL ADD IMMEUBLE_ID NUMBER(19) constraint FK_EVTFISC_IMMEUBLE_ID references RF_IMMEUBLE;
ALTER TABLE EVENEMENT_FISCAL ADD COMMUNAUTE_ID NUMBER(19) constraint FK_EVTFISC_COMMUNAUTE_ID references RF_IMMEUBLE;

CREATE TABLE EVT_FISCAL_SERVITUDE_AYANTDRT (
	EVENEMENT_ID   NUMBER(19) NOT NULL CONSTRAINT FK_EVTSERVAD_EVTFISC_ID REFERENCES EVENEMENT_FISCAL,
	AYANT_DROIT_ID NUMBER(19) NOT NULL CONSTRAINT FK_EVTSERVAD_AYANTDRT_ID REFERENCES RF_AYANT_DROIT,
	PRIMARY KEY (EVENEMENT_ID, AYANT_DROIT_ID)
);

CREATE TABLE EVT_FISCAL_SERVITUDE_IMMEUBLE (
	EVENEMENT_ID NUMBER(19) NOT NULL CONSTRAINT FK_EVTSERVIMM_EVTFISC_ID REFERENCES EVENEMENT_FISCAL,
	IMMEUBLE_ID  NUMBER(19) NOT NULL CONSTRAINT FK_EVTSERVIMM_IMM_ID REFERENCES RF_IMMEUBLE,
	PRIMARY KEY (EVENEMENT_ID, IMMEUBLE_ID)
);