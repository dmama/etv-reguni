-- Version
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('3.4', '3.3_3.4_upgrade');
...
alter table EVENEMENT_IDENTIFICATION_CTB modify (BUSINESS_USER nvarchar2(255));
alter table EVENEMENT_IDENTIFICATION_CTB modify (BUSINESS_ID nvarchar2(255));
alter table EVENEMENT_IDENTIFICATION_CTB modify (REPLY_TO nvarchar2(255));
...
--
-- Lien tache -> collectivite administrative
--
