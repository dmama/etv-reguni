...
UPDATE ETAT_DOCUMENT_FISCAL SET ETAT_TYPE = 'DI_EMISE' WHERE TYPE = 'EMISE';
UPDATE ETAT_DOCUMENT_FISCAL SET ETAT_TYPE = 'DI_SOMMEE' WHERE TYPE = 'SOMMEE';
UPDATE ETAT_DOCUMENT_FISCAL SET ETAT_TYPE = 'DI_RAPPELEE' WHERE TYPE = 'RAPPELEE';
UPDATE ETAT_DOCUMENT_FISCAL SET ETAT_TYPE = 'DI_ECHUE' WHERE TYPE = 'ECHUE';
UPDATE ETAT_DOCUMENT_FISCAL SET ETAT_TYPE = 'DI_SUSPENDUE' WHERE TYPE = 'SUSPENDUE';
UPDATE ETAT_DOCUMENT_FISCAL SET ETAT_TYPE = 'DI_RETOURNEE' WHERE TYPE = 'RETOURNEE';
