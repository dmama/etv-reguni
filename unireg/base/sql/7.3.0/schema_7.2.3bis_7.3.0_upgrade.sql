...
ALTER TABLE DOCUMENT_FISCAL ADD CONSTRAINT FK_DD_RF_IMMEUBLE_ID FOREIGN KEY (DD_IMMEUBLE_ID) REFERENCES RF_IMMEUBLE;
...
ALTER TABLE AUTRE_DOCUMENT_FISCAL RENAME TO OBSOLETE_AUTRE_DOCUMENT_FISCAL;