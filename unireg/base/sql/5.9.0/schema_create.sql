...
CREATE TABLE EVENEMENT_REQDES (ID NUMBER(19,0) NOT NULL, ANNULATION_DATE TIMESTAMP, ANNULATION_USER NVARCHAR2(65), LOG_CDATE TIMESTAMP, LOG_CUSER NVARCHAR2(65), LOG_MDATE TIMESTAMP, LOG_MUSER NVARCHAR2(65), XML CLOB NOT NULL, DATE_ACTE NUMBER(10,0) NOT NULL, NUMERO_MINUTE NUMBER(19,0) NOT NULL, VISA_NOTAIRE NVARCHAR2(65) NOT NULL, NOM_NOTAIRE NVARCHAR2(100) NOT NULL, PRENOM_NOTAIRE NVARCHAR2(100) NOT NULL, VISA_OPERATEUR NVARCHAR2(65), NOM_OPERATEUR NVARCHAR2(100), PRENOM_OPERATEUR NVARCHAR2(100), PRIMARY KEY (ID));
CREATE UNIQUE INDEX IDX_REQDES_EVT_NO_MINUTE ON EVENEMENT_REQDES(NUMERO_MINUTE ASC);
...
CREATE TABLE REQDES_ROLE_PARTIE_PRENANTE (ID NUMBER(19,0) NOT NULL, ANNULATION_DATE TIMESTAMP, ANNULATION_USER NVARCHAR2(65), LOG_CDATE TIMESTAMP, LOG_CUSER NVARCHAR2(65), LOG_MDATE TIMESTAMP, LOG_MUSER NVARCHAR2(65), PARTIE_PRENANTE_ID NUMBER(19,0) NOT NULL, OFS_COMMUNE NUMBER(10,0) NOT NULL, ROLE NVARCHAR2(10) NOT NULL, PRIMARY KEY (ID));
