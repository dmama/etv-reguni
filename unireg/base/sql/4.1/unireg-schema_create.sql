...
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('4.1', 'create');
...
alter table MOUVEMENT_DOSSIER add constraint FK_ENV_DOS_OID_EMETTEUR foreign key (OID_EMETTEUR) references TIERS;
