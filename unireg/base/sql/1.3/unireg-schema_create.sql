...
create table EVENEMENT_FISCAL (id number(19,0) not null, INDEX_DIRTY number(1,0), LOG_CDATE timestamp, LOG_CUSER varchar2(255 char), LOG_MDATE timestamp, LOG_MUSER varchar2(255 char), DATE_EVENEMENT date, type varchar2(255 char), TIERS_ID number(19,0), primary key (id));

create table FOR_FISCAL (FOR_TYPE varchar2(31 char) not null, id number(19,0) not null, INDEX_DIRTY number(1,0), LOG_CDATE timestamp, LOG_CUSER varchar2(255 char), LOG_MDATE timestamp, LOG_MUSER varchar2(255 char), EST_ANNULE number(1,0), DATE_FERMETURE timestamp, DATE_OUVERTURE timestamp, forGestion number(1,0), GENRE_IMPOT varchar2(255 char), NUMERO_OFS number(10,0), rattachement varchar2(255 char), TYPE_FOR varchar2(255 char), CAT_IMP_ORD varchar2(255 char), motifFermeture number(10,0), motifOuverture number(10,0), CTB_ID number(19,0), primary key (id));

create table IDENTIFICATION_PERSONNE (id number(19,0) not null, INDEX_DIRTY number(1,0), LOG_CDATE timestamp, LOG_CUSER varchar2(255 char), LOG_MDATE timestamp, LOG_MUSER varchar2(255 char), identifiant varchar2(255 char), nonHabitant raw(255), source varchar2(255 char), NON_HABITANT_ID number(19,0), primary key (id));
...
create table RAPPORT_ENTRE_TIERS (RAPPORT_ENTRE_TIERS_TYPE varchar2(31 char) not null, id number(19,0) not null, INDEX_DIRTY number(1,0), LOG_CDATE timestamp, LOG_CUSER varchar2(255 char), LOG_MDATE timestamp, LOG_MUSER varchar2(255 char), DATE_DEBUT timestamp, DATE_FIN timestamp, TYPE varchar2(255 char), DATE_FIN_DER_ELE_IMP timestamp, tauxActivite number(10,0), typeActivite varchar2(255 char), TIERS_SUJET_ID number(19,0), TIERS_OBJET_ID number(19,0), primary key (id));

create table SITUATION_FAMILLE (id number(19,0) not null, DATE_DEBUT timestamp, DATE_FIN timestamp, NOMBRE_ENFANTS number(10,0), TARIF_APPLICABLE varchar2(255 char), TIERS_ID number(19,0), CTB_ID number(19,0), primary key (id));

create table TIERS (TIERS_TYPE varchar2(31 char) not null, NUMERO number(19,0) not null, INDEX_DIRTY number(1,0), LOG_CDATE timestamp, LOG_CUSER varchar2(255 char), LOG_MDATE timestamp, LOG_MUSER varchar2(255 char), ADRESSE_BIC_SWIFT varchar2(255 char), ADRESSE_EMAIL varchar2(255 char), BLOC_REMB_AUTO number(1,0), COMPLEMENT_NOM varchar2(255 char), DATE_DEBUT_ACTI timestamp, DATE_FIN_ACTI timestamp, NUMERO_COMPTE_BANCAIRE varchar2(255 char), NUMERO_TELECOPIE varchar2(255 char), NUMERO_TEL_PORTABLE varchar2(255 char), NUMERO_TEL_PRIVE varchar2(255 char), NUMERO_TEL_PROF varchar2(255 char), PERSONNE_CONTACT varchar2(255 char), REMARQUE varchar2(255 char), TITULAIRE_COMPTE_BANCAIRE varchar2(255 char), AC_FORME_JURIDIQUE varchar2(255 char), AC_NOM varchar2(255 char), NUMERO_CA number(19,0), CATEGORIE_IMPOT_SOURCE varchar2(255 char), MODE_COM varchar2(255 char), MOIS_ENVOI varchar2(255 char), PERIODICITE_DECOMPTE varchar2(255 char), SANS_LISTE_RECAP number(1,0), SANS_RAPPEL number(1,0), NUMERO_ENTREPRISE number(19,0), NUMERO_ETABLISSEMENT number(19,0), ANCIEN_NUMERO_SOURCIER number(19,0), NUMERO_INDIVIDU number(19,0), NH_DATE_DEBUT_VALID_AUTORIS timestamp, NH_DATE_NAISSANCE number(10,0), NH_DECEDE number(1,0), NH_ETAT_CIVIL varchar2(255 char), NH_MOTIF_DISS_PART varchar2(255 char), NH_NOM varchar2(255 char), NH_NUMERO_ASSURE_SOCIAL varchar2(255 char), NH_NO_OFS_PAYS_ORIGINE number(10,0), NH_PRENOM varchar2(255 char), NH_SEPARATION varchar2(255 char), NH_SEXE varchar2(255 char), NH_TYPE_AUTORIS varchar2(255 char), CTB_DPI_ID number(19,0), primary key (NUMERO));
...
alter table SITUATION_FAMILLE add constraint FK8565EE6DD027BF14 foreign key (TIERS_ID) references TIERS;
