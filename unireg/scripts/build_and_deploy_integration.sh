...
# ajoute le suffixe '-is' au fichier de log
ssh $user "sed 's/unireg-web\.log/unireg-web-is.log/' $upDir/explode/config/$env/unireg-log4j.xml > $configDir/unireg-log4j.xml"
