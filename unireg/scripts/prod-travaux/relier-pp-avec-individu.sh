...
echo "UPDATE EVENEMENT_CIVIL_REGROUPE SET LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-$JIRA', HAB_PRINCIPAL=$CTB_PP WHERE NO_INDIVIDU_PRINCIPAL=$IND;"
echo "UPDATE EVENEMENT_CIVIL_REGROUPE SET LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-$JIRA', HAB_CONJOINT=$CTB_PP WHERE NO_INDIVIDU_CONJOINT=$IND;"
