...
echo "UPDATE EVENEMENT_CIVIL SET LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-$JIRA', HAB_PRINCIPAL=NULL WHERE NO_INDIVIDU_PRINCIPAL=$IND;"
echo "UPDATE EVENEMENT_CIVIL SET LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-$JIRA', HAB_CONJOINT=NULL WHERE NO_INDIVIDU_CONJOINT=$IND;"
