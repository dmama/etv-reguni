...
echo "UPDATE EVENEMENT_CIVIL SET LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-SIFISC-$JIRA', HAB_PRINCIPAL=$CTB_PP WHERE NO_INDIVIDU_PRINCIPAL=$IND AND HAB_PRINCIPAL!=$CTB_PP;"
echo "UPDATE EVENEMENT_CIVIL SET LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-SIFISC-$JIRA', HAB_CONJOINT=$CTB_PP WHERE NO_INDIVIDU_CONJOINT=$IND AND HAB_CONJOINT!=$CTB_PP;"
