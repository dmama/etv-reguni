...
echo "UPDATE TIERS SET TIERS_TYPE='MenageCommun', LOG_MDATE=CURRENT_DATE, LOG_MUSER='SQL-SIFISC-$JIRA', PP_HABITANT=NULL, NUMERO_INDIVIDU=NULL, INDEX_DIRTY=1 WHERE NUMERO=$PP AND TIERS_TYPE='PersonnePhysique';"
