...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="title">
		<fmt:message key="title.traitement.revocation.faillite.entreprise">
			<fmt:param>
	...
	<tiles:put name="body">
		...
		<form:form method="post" id="recapFaillite" name="recapFaillite">
			...
			<fieldset>
				...
				<table>
					<tr class="<unireg:nextRowClass/>" >
						...
						<td width="75%"><unireg:regdate regdate="${command.datePrononceFaillite}"/></td>
					</tr>
					<tr class="<unireg:nextRowClass/>">
			...
			<input type="submit" value="<fmt:message key="label.bouton.sauver"/>" onClick="return confirm('Voulez-vous vraiment révoquer la faillite de cette entreprise ?');" />
			<!-- Fin Boutons -->
