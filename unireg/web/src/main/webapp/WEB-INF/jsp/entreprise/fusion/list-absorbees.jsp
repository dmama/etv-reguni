  	...
  	<tiles:put name="body">
	    ...
	    <fieldset>
		    ...
		    <display:table name="fusion.entreprisesAbsorbees" id="absorbee">
			    ...
			    <display:column titleKey="label.date.inscription.rc" property="dateInscription"/>
	    ...
	    <unireg:RetourButton link="../retour-choix-dates.do" message="Voulez-vous vraiment quitter cette page sans sauver ?"/>
