...
<%--@elvariable id="command" type="ch.vd.uniregctb.entreprise.EditRaisonEnseigneEtablissementView"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<form:form id="editRaisonEnseigneForm" commandName="command" action="edit.do">
			...
			<unireg:buttonTo method="get" action="/civil/entablissement/edit.do" params="{id:${command.tiersId}}" name="${libelleBoutonRetour}" confirm="${confirmationMessageRetour}"/>
