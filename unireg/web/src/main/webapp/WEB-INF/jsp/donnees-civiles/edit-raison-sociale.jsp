...
<%--@elvariable id="command" type="ch.vd.uniregctb.entreprise.EditRaisonSocialeView"--%>
			...
			<fieldset>
				...
				<table border="0">
					...
					<tr class="<unireg:nextRowClass/>" >
						...
						<td>
							<input id="raisonSociale" name="raisonSociale" value="${command.raisonSociale}" size="25" ></td>
