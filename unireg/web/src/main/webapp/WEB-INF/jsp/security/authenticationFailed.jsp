...
<tiles:insert template="/WEB-INF/jsp/templates/templateLight.jsp">
	...
	<tiles:put name="body" type="String">
		<p>Une erreur est survenue lors de la connexion à IfoSec.</p>
		<p>IfoSec peut être temporairement indisponible, ou un autre
		problème prévient IfoSec de fonctionner correctement. Il est aussi
