...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="body">
		...
		<display:table 	name="listEvenements" id="row" pagesize="25" requestURI="/evenement/list.do" sort="external" class="display_table" partialList="true" size="listEvenementsSize">
