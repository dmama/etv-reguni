...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="title">
  		<fmt:message key="title.annulation.couple.recherche.menage.commun" />
  	</tiles:put>
  	...
  	<tiles:put name="body">
		...
		<display:table 	name="list" id="row" pagesize="25" requestURI="/annulation/couple/list.do" class="display" sort="list">
