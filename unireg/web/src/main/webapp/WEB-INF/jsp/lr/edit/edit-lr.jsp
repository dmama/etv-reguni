...
<%--@elvariable id="lr" type="ch.vd.uniregctb.lr.view.ListeRecapitulativeDetailView"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<jsp:include page="../../general/debiteur.jsp">
			<jsp:param name="idDebiteur" value="${lr.idDebiteur}" />
		</jsp:include>
		...
		<fieldset>
			...
			<display:table 	name="lr.delais" id="delai" pagesize="10" class="display" decorator="ch.vd.uniregctb.decorator.TableEntityDecorator">
