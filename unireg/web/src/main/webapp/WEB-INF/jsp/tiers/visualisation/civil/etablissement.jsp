...
<fieldset>
	...
	<c:if test="${page == 'edit' && (etablissement.connueAuCivil && empty etablissement.numerosIDE || ! entreprise.connueAuCivil) && autorisations.donneesCiviles && autorisations.identificationEntreprise}">
		<table border="0">
			<tr>
				<td>
