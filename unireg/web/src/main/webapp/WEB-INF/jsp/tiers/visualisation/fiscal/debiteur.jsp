...
<fieldset>
		...
		<c:if test="${not empty command.periodicites}">
			...
			<display:table name="command.periodicites" id="periodicite" pagesize="10" requestURI="visu.do" class="display" decorator="ch.vd.uniregctb.decorator.TablePeriodiciteDecorator" sort="external">
