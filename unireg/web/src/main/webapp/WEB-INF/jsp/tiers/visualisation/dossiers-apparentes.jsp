...
<script>
	...
	function buildRapportsTable(rapports) {
		...
		for (var i in rapports) {
			...
			html += '<td><a href="#" class="consult" title="Consultation des logs" onclick="return open_consulter_log(\'RapportEntreTiers\', ' + rapport.id + ');">&nbsp;</a></td>';
			html += '</tr>\n';
		}
	...
	function buildTableDebiteurs(debiteurs) {
		...
		for (var i in debiteurs) {
			...
			html += '<td><a href="#" class="consult" title="Consultation des logs" onclick="return open_consulter_log(\'RapportEntreTiers\', ' + debiteur.id + ');">&nbsp;</a></td>';
			html += '</tr>\n';
		}
