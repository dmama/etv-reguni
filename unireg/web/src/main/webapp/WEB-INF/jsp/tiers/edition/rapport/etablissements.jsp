...
<fieldset>
	...
	<c:if test="${not empty command.rapportsEtablissements}">
		<display:table name="command.rapportsEtablissements" id="rapportEtablissement" pagesize="10" requestURI="edit.do" sort="list" class="display" decorator="ch.vd.uniregctb.decorator.TableEntityDecorator">
