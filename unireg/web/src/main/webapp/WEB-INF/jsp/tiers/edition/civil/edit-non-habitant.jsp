				...
				<fieldset class="information">
					...
					<table border="0">
						...
						<tr class="<unireg:nextRowClass/>">
							...
							<td>
								<form:input path="nom" tabindex="2" id="tiers_nom" cssErrorClass="input-with-errors"
								            size="20" maxlength="${lengthnom}" />
						...
						<tr class="<unireg:nextRowClass/>">
							...
							<td>
								<form:select path="categorieEtranger" tabindex="8" >
									<form:option value=""/>
						...
						<tr class="<unireg:nextRowClass/>">
							...
							<td width="60%">
								<form:input path="prenomsPere" tabindex="12" id="tiers_prenomsPere" cssErrorClass="input-with-errors"
						...
						<tr class="<unireg:nextRowClass/>">
							...
							<td width="60%">
								<form:input path="nomPere" tabindex="13" id="tiers_nomPere" cssErrorClass="input-with-errors"
								            size="20" maxlength="${lengthnomparents}" />
						...
						<tr class="<unireg:nextRowClass/>">
							...
							<td width="60%">
								<form:input path="prenomsMere" tabindex="14" id="tiers_prenomsMere" cssErrorClass="input-with-errors"
								            size="20" maxlength="${lengthnomparents}" />
						...
						<tr class="<unireg:nextRowClass/>">
							...
							<td width="60%">
								<form:input path="nomMere" tabindex="15" id="tiers_nomMere" cssErrorClass="input-with-errors"
								            size="20" maxlength="${lengthnomparents}" />
