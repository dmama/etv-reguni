...
<fieldset>
	...
	<c:if test="${page == 'edit' && (entreprise.connueAuCivil && empty entreprise.numerosIDE || ! entreprise.connueAuCivil) && autorisations.donneesCiviles && autorisations.identificationEntreprise}">
		<table border="0">
			<tr>
				<td>
