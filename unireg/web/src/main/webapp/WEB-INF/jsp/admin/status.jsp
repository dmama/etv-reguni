  	...
  	<tiles:put name="body">
		...
		<fieldset class="info">
			...
			<table class="display_table">
				<thead>
					<tr>
						<th/><th>Etat</th>
						<th>Ping (5 dernières minutes)</th>
						<th>Ping (depuis le début)</th>
						<th>Hits Percent</th>
						<th>Hits Count</th>
						<th>Total Calls</th>
					</tr>
				...
				<tbody>
					<tr>
						...
						<td><c:out value="${serviceCivilStats.recentPing}"/> ms</td>
						<td><c:out value="${serviceCivilStats.totalPing}"/> ms</td>
						<td><c:out value="${serviceCivilStats.hitsPercent}"/> %</td>
						<td><c:out value="${serviceCivilStats.hitsCount}"/></td>
						<td><c:out value="${serviceCivilStats.totalCount}"/></td>
					</tr>
					<tr>
						<td><fmt:message key="label.info.service.infra"/></td>
						<td id="serviceInfraStatus"><c:out value="${serviceInfraStatus}" escapeXml="false"/></td>
						<td><c:out value="${serviceInfraStats.recentPing}"/> ms</td>
						<td><c:out value="${serviceInfraStats.totalPing}"/> ms</td>
						<td><c:out value="${serviceInfraStats.hitsPercent}"/> %</td>
						<td><c:out value="${serviceInfraStats.hitsCount}"/></td>
						<td><c:out value="${serviceInfraStats.totalCount}"/></td>
					</tr>
					<tr>
						...
						<td><c:out value="${serviceSecuriteStats.recentPing}"/> ms</td>
						<td><c:out value="${serviceSecuriteStats.totalPing}"/> ms</td>
						<td><c:out value="${serviceSecuriteStats.hitsPercent}"/> %</td>
						<td><c:out value="${serviceSecuriteStats.hitsCount}"/></td>
						<td><c:out value="${serviceSecuriteStats.totalCount}"/></td>
					</tr>
					<tr>
					...
					<tr>
						<td><fmt:message key="label.info.indexeur"/></td>
						<td><c:out value="${indexeurStatus}" escapeXml="false"/></td>
						<td><c:out value="${indexeurStats.recentPing}"/> ms</td>
						<td><c:out value="${indexeurStats.totalPing}"/> ms</td>
						<td><c:out value="${indexeurStats.hitsPercent}"/> %</td>
						<td><c:out value="${indexeurStats.hitsCount}"/></td>
						<td><c:out value="${indexeurStats.totalCount}"/></td>
					</tr>
					<tr>
						<td><fmt:message key="label.info.ws.tiers"/></td>
						<td><c:out value="${wsTiersStatus}" escapeXml="false"/></td>
						<td><c:out value="${wsTiersStats.recentPing}"/> ms</td>
						<td><c:out value="${wsTiersStats.totalPing}"/> ms</td>
						<td><c:out value="${wsTiersStats.hitsPercent}"/> %</td>
						<td><c:out value="${wsTiersStats.hitsCount}"/></td>
						<td><c:out value="${wsTiersStats.totalCount}"/></td>
					</tr>
					<tr>
						<td><fmt:message key="label.info.ws.tiers2"/></td>
						<td><c:out value="${wsTiers2Status}" escapeXml="false"/></td>
						<td><c:out value="${wsTiers2Stats.recentPing}"/> ms</td>
						<td><c:out value="${wsTiers2Stats.totalPing}"/> ms</td>
						<td><c:out value="${wsTiers2Stats.hitsPercent}"/> %</td>
						<td><c:out value="${wsTiers2Stats.hitsCount}"/></td>
						<td><c:out value="${wsTiers2Stats.totalCount}"/></td>
					</tr>
				</tbody>
			</table>
		</fieldset>
		...
		<authz:authorize ifAnyGranted="ROLE_TESTER, ROLE_ADMIN">
			...
			<%-- Ajuste la taille du div extprop.output par rapport à celle du div extprop.div,ceci pour 
			     contourner une limitation du style 'overflow:auto' qui ne supporte pas des taills relatives --%>
			<script type="text/javascript" language="Javascript1.3">
