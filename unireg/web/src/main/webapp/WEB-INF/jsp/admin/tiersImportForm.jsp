...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="body">
		...
		<fieldset>
		    ...
		    <br/>
			<br/>
		    <input type="button" value="<fmt:message key="label.bouton.exporter.tierslist"/>" onclick="javascript:submit('dbdump.do?action=dumptiers&tiers=' + document.getElementById('tiersList').value);"/>
		    <span class="error"><fmt:message key="label.export.DBUnit.exporttiers.remark"/></span>
		    <input id="tiersList" name="tiersList">&nbsp;<fmt:message key="label.export.DBUnit.exporttiers.explanation"/>
