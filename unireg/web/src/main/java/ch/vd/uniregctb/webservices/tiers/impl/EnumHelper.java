...
import ch.vd.uniregctb.individu.EtatCivilHelper;
...
import ch.vd.uniregctb.webservices.tiers.Sexe;
...
public abstract class EnumHelper {
	...
	public static ForFiscal.GenreImpot coreToWeb(ch.vd.uniregctb.type.GenreImpot genreImpot) {
		if (genreImpot == null || genreImpot == GenreImpot.BENEFICE_CAPITAL) {
			return null;
		}
	...
	public static ForFiscal.MotifRattachement coreToWeb(ch.vd.uniregctb.type.MotifRattachement rattachement) {
		if (rattachement == null || rattachement == MotifRattachement.ETABLISSEMENT_STABLE) {
			return null;
		}
