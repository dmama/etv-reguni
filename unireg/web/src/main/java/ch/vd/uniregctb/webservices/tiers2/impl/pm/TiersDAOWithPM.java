...
public class TiersDAOWithPM implements TiersDAO {
	...
	private TiersWebServiceWithPM wsPM;

	public void setTarget(TiersDAO target) {
		this.target = target;
	}

	public void setWsPM(TiersWebServiceWithPM wsPM) {
		this.wsPM = wsPM;
	}

	public boolean exists(Long id) {
		return target.exists(id) || wsPM.existsPM(id);
	}

	public List<Long> getAllIds() {
		final List<Long> list = wsPM.getAllIdsPM();
