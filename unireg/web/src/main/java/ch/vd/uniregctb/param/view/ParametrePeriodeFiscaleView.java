...
public class ParametrePeriodeFiscaleView {
	...
	public Long getIdVaud() {
		return idVaud;
	}
	public void setIdVaud(Long idVaud) {
		this.idVaud = idVaud;
	}
	public Long getIdHorsCanton() {
		return idHorsCanton;
	}
	public void setIdHorsCanton(Long idHorsCanton) {
		this.idHorsCanton = idHorsCanton;
	}
	public Long getIdHorsSuisse() {
		return idHorsSuisse;
	}
	public void setIdHorsSuisse(Long idHorsSuisse) {
		this.idHorsSuisse = idHorsSuisse;
	}
