...
public class TiersVisuManagerImpl extends TiersManager implements TiersVisuManager {
	 ...
	 */
	public TiersVisuView getView(Long numero, boolean adressesHisto, WebParamPagination webParamPagination) throws AdressesResolutionException, InfrastructureException{
	 ...
	 * @throws AdressesResolutionException
	 */
	private List<AdresseView> getAdressesHistoriques(Tiers tiers, boolean adresseHisto) throws AdressesResolutionException{

		List<AdresseView> adresses = new ArrayList<AdresseView>();

		if (adresseHisto) {
			final AdressesFiscalesHisto adressesFiscalHisto = adresseService.getAdressesFiscalHisto(tiers);
			...
			final AdressesFiscales adressesFiscales = adresseService.getAdressesFiscales(tiers, null);
