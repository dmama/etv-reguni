...
public class EvenementManagerImpl implements EvenementManager, MessageSourceAware {
	 ...
	 */
	public EvenementView get(Long id)  throws AdressesResolutionException, InfrastructureException {
		...
		AdresseEnvoi adressePrincipal = adresseService.getAdresseEnvoi(individu, RegDate.get());
		...
		if (conjoint != null) {
			...
			AdresseEnvoi adresseConjoint = adresseService.getAdresseEnvoi(conjointInd, RegDate.get());
	 ...
	 */
	private String getLocaliteOuPays(Tiers tiers) throws AdressesResolutionException {

		String localiteOuPays = "";

		AdresseGenerique adresseCourrier = adresseService.getAdresseFiscale(tiers, TypeAdresseTiers.COURRIER, null);
	 ...
	 * @throws InfrastructureException
	 */
	private TiersAssocieView setTiersAssocieView(Tiers tiers) throws AdressesResolutionException, InfrastructureException {
		final TiersAssocieView tiersAssocie = new TiersAssocieView();
		tiersAssocie.setNumero(tiers.getNumero());

		final List<String> nomCourrier = adresseService.getNomCourrier(tiers, null);
	...
	private EvenementCivilRegroupeView buildView(EvenementCivilRegroupe evt) throws AdressesResolutionException {
