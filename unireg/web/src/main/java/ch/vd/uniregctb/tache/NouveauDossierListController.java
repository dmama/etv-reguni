...
public class NouveauDossierListController extends AbstractTacheController {
	...
	protected Object formBackingObject(HttpServletRequest request) throws Exception {
		...
		LOGGER.debug("Start of NouveauDossierListController:formBackingObject");
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors)
		...
		if (request.getParameter(BOUTON_IMPRIMER) != null) {
			...
			if (pdf == null) {
				throw new EditiqueCommunicationException("La communication avec l'éditique a échoué. Veuillez recommencer l'opération ultérieurement");
			}
