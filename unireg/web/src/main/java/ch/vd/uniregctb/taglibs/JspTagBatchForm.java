...
public class JspTagBatchForm extends BodyTagSupport {
	...
	private static String renderCommuneParam(GestionJob job, JobParam param) {
		...
		b.append("    var ").append(idDivAutoComplete).append(" = new AutoComplete(\"").append(idInputNomCommune).append("\", \"").append(
				idDivAutoComplete + "\");\n");
	...
	private static String renderOIDParam(GestionJob job, JobParam param) {
		...
		// champ de saisie visible à l'utilisateur
		b.append("<input id=\"").append(idInputNomOID).append("\" name=\"").append(idInputNomOID).append(
				"\" type=\"text\" value=\"" + defaultNomOID).append("\" size=\"25\" />\n");

		// champ contenant le numéro invisible à l'utilisateur
		b.append("<input id=\"").append(idInputNoColAdm).append("\" name=\"").append(idInputNoColAdm).append("\" type=\"hidden\" value=\"")
				.append(defaultNoColAdm + "\" />\n");
		...
		b.append("    var ").append(idDivAutoComplete).append(" = new AutoComplete(\"").append(idInputNomOID).append("\", \"").append(
				idDivAutoComplete + "\");\n");
		b.append("    var item = ").append(idDivAutoComplete).append(";\n");
