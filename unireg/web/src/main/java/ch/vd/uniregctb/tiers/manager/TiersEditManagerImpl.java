...
public class TiersEditManagerImpl extends TiersManager implements TiersEditManager {
	 ...
	 */
	public TiersEditView getComplementView(Long numero) throws AdressesResolutionException, InfrastructureException{
	 ...
	 * @throws InfrastructureException
	 */
	public TiersEditView getDebiteursView(Long numero) throws AdressesResolutionException, InfrastructureException{
		TiersEditView tiersEditView = new TiersEditView();
		if ( numero == null) {
			return null;
		}
	 ...
	 * @throws InfrastructureException
	 */
	public TiersEditView refresh(TiersEditView tiersEditView, Long numero) throws AdressesResolutionException, InfrastructureException{
		if ( numero == null) {
			return null;
		}
