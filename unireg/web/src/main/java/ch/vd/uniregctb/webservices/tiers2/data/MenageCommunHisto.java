...
public class MenageCommunHisto extends ContribuableHisto {
	...
	public MenageCommunHisto(ch.vd.uniregctb.tiers.MenageCommun menageCommun, Set<TiersPart> parts, Context context) throws BusinessException {
	...
	private final void copyParts(MenageCommunHisto menageCommun, Set<TiersPart> parts) {
	...
	private void initParts(Context context, ch.vd.uniregctb.tiers.MenageCommun menageCommun, Set<TiersPart> parts) throws BusinessException {
		if (parts != null && parts.contains(TiersPart.COMPOSANTS_MENAGE)) {
			initComposants(menageCommun, context);
		}
	}

	private void initComposants(ch.vd.uniregctb.tiers.MenageCommun menageCommun, Context context) throws BusinessException {
		ch.vd.uniregctb.evenement.common.EnsembleTiersCouple ensemble = context.tiersService.getEnsembleTiersCouple(menageCommun, null);
