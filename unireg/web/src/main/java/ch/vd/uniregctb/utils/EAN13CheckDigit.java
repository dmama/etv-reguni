 ...
 * or length of a code. {@link EAN13CheckDigit} provides for separating out
 ...
 * {@link EAN13CheckDigit} also defines behaviour for calculating/generating check
 ...
 * <p>
 * {@link EAN13CheckDigit} is used by the new generic
 ...
 *
 * @see org.apache.commons.validator.routines.AVSValidator
 * @version $Revision: 493905 $ $Date: 2007-01-07 18:11:38 -0800 (Sun, 07 Jan 2007) $
 * @since Validator 1.4
 */
public interface EAN13CheckDigit {
     ...
     * @throws EAN13CheckDigitException if an error occurs.
     */
