...
public class ListeRecapListManagerImpl implements ListeRecapListManager{
	...
	private ListeRecapDetailView getView(DeclarationImpotSource lr) throws AdressesResolutionException {
	 ...
	 */
	public List<ListeRecapDetailView> find(ListeRecapCriteria lrCriteria, ParamPagination paramPagination) throws AdressesResolutionException {
