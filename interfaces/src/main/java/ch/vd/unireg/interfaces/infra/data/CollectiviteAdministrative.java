...
public interface CollectiviteAdministrative {
	...
	/**
	 * Retourne l'adresse email par DEFAUT de la collectivité administrative. Si la collectivité ne possede pas d'email pour le code usage STANDARD, null est retourné.
	 *
	...
	/**
	 * @return L'ensemble des type d'échange possible pour la collectivité.
	 */
	List<EchangeAciCom> getEchangeAciCom();
}
