...
public class MockRue implements Rue {
	...
	private final Supplier<MockLocalite> localiteSupplier;
	private final String designationCourrier;
	private final Integer noRue;

	public MockRue(@NotNull Supplier<MockLocalite> localiteSupplier, String designationCourrier, Integer noTechniqueRue) {
	...
	public Integer getNoLocalite() {
		return localiteSupplier.get().getNoOrdre();
	}
