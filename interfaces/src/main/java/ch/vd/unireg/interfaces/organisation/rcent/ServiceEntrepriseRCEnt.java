...
import ch.vd.unireg.interfaces.organisation.WrongEntrepriseReceivedException;
...
public class ServiceEntrepriseRCEnt implements ServiceEntrepriseRaw {
	...
	public EntrepriseCivile getEntrepriseHistory(long noEntreprise) throws ServiceEntrepriseException {
		try {
			final ch.vd.unireg.interfaces.organisation.rcent.adapter.model.Organisation received = adapter.getOrganisationHistory(noEntreprise);
			if (received == null) {
				return null;
			}
	...
	public Long getNoEntrepriseFromNoEtablissement(Long noEtablissementCivil) throws ServiceEntrepriseException {
		try {
			final ch.vd.unireg.interfaces.organisation.rcent.adapter.model.Organisation received = adapter.getLocation(noEtablissementCivil);
			if (received == null) {
				return null;
			}
