...
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.builders.OrganisationBuilder;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.builders.OrganisationLocationBuilder;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.collector.IndexedDataCollector;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.collector.ListDataCollector;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.collector.MultiValueDataCollector;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.collector.MultiValueIndexedDataCollector;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.collector.SingleValueIndexedDataCollector;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.equalator.AdresseEqualator;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.equalator.BURRegistrationDataEqualator;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.equalator.CapitalEqualator;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.equalator.NamedOrganisationIdEqualator;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.equalator.RCRegistrationDataEqualator;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.AdressesCasePostaleIdeExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.AdressesEffectivesIdeExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.AdressesLegalesExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.BURRegistrationDataExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationAdditionalNameExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationBurTransferFromExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationBurTransferToExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationIdentifiersExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationLegalFormExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationMunicipalityExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationNamesExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationRcByLawsDateExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationRcPurposeExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationTypeExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationUidInReplacementOfExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationUidReplacedByExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.LocationsExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.RCCapitalExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.RCRegistrationDataExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.UidDeregistrationReasonExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.UidKindOfUidEntityExtractor;
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.historizer.extractor.UidRegistrationStatusExtractor;
...
import ch.vd.unireg.interfaces.entreprise.rcent.adapter.service.RCEntAdapterException;
...
public class OrganisationHistorizer {
	 ...
	 */
	public ch.vd.unireg.interfaces.entreprise.rcent.adapter.model.Organisation mapOrganisation(List<OrganisationSnapshot> snapshots) {
