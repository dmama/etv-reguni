package ch.vd.uniregctb.fiscal.service.impl.test;
...
import ch.vd.uniregctb.fiscal.service.impl.RetourInformationDiMDB;

public class RetourInformationDiMDBTestCase extends TestCase {
	...
	public void testCreateContribuableRetourInfoDiFromDocument() {
		try {
			RetourInformationDiMDB mdb = new RetourInformationDiMDB();
	...
	public void a_testSendMessage() throws Exception {
		...
		try {
			...
			ConnectionFactory qcf = (ConnectionFactory) ctx.lookup("weblogic.jms.ConnectionFactory");
	...
	public static void main(String[] args) {
		RetourInformationDiMDBTestCase launcher = new RetourInformationDiMDBTestCase();
		try {
