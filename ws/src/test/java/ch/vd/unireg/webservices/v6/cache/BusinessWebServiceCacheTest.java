...
import static ch.vd.unireg.xml.party.v4.PartyPart.*;
...
public class BusinessWebServiceCacheTest extends WebserviceTest {
	...
	public void onSetUp() throws Exception {
		...
		final BusinessWebService webService = getBean(BusinessWebService.class, "wsv6Business");
		...
		wsCacheManager = getBean(BusinessWebServiceCacheEventListener.class, "wsv6CacheEventListener");
	...
	public void onTearDown() throws Exception {
		wsCacheManager.setCache(getBean(BusinessWebServiceCache.class, "wsv6Cache"));
		super.onTearDown();
	}
	...
	private static void assertOnlyPart(PartyPart p, Party tiers) {
		...
		boolean checkTaxLightenings = TAX_LIGHTENINGS == p;
		...
		boolean checkBusinessYears = BUSINESS_YEARS == p;
		boolean checkCorporationFlags = CORPORATION_FLAGS == p;
		assertTrue("La partie [" + p + "] est inconnue",
		                  checkAddresses || checkTaxLiabilities || checkSimplifiedTaxLiabilities || checkHouseholdMembers || checkBankAccounts || checkTaxDeclarations || checkTaxDeclarationsStatuses || checkTaxDeclarationsDeadlines
				                  ...
				                  || checkChildren || checkParents || checkWithholdingTaxDeclarationPeriods || checkEbillingStatuses || checkCorporationStatuses);
