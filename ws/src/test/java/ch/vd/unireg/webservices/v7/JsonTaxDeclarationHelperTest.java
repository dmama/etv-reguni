...
public class JsonTaxDeclarationHelperTest extends WithoutSpringTest {
	...
	private static OrdinaryTaxDeclaration buildOrdinaryTaxDeclaration(long id, Date dateFrom, Date dateTo, Date cancellationDate, TaxPeriod taxPeriod,
	                                                                  ...
	                                                                  OrdinaryTaxDeclarationType documentType, long managingMunicipalityFSOId, Integer segmentationCode) {
	...
	public void testMutationNoNulls() throws Exception {
		...
		doTest(buildOrdinaryTaxDeclaration(12, generateRandomDate(), generateRandomDate(), generateRandomDate(), generateRandomTaxPeriod(), statuses, deadlines, 42, OrdinaryTaxDeclarationType.CORPORATE_ENTITY_TAX_DECLARATION, 231674L, 12), TaxDeclarationType.ORDINARY_TAX_DECLARATION);
	...
	public void testAlreadyJson() throws Exception {
		...
		doTestAlreadyJson(buildOrdinaryTaxDeclaration(12, generateRandomDate(), generateRandomDate(), generateRandomDate(), generateRandomTaxPeriod(), statuses, deadlines, 42, OrdinaryTaxDeclarationType.CORPORATE_ENTITY_TAX_DECLARATION, 231674L, 12));
