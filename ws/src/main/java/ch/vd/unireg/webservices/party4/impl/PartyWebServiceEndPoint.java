...
import ch.vd.unireg.webservices.party4.Request;
...
@WebService(targetNamespace = "http://www.vd.ch/fiscalite/unireg/webservices/party4", serviceName = "PartyWebServiceFactory", portName = "Service",
		endpointInterface = "ch.vd.unireg.webservices.party4.PartyWebService")
public class PartyWebServiceEndPoint implements PartyWebService, DetailedLoadMonitorable {
	...
	private static final Logger READ_ACCESS = LoggerFactory.getLogger("party4.read");
	private static final Logger WRITE_ACCESS = LoggerFactory.getLogger("party4.write");
	...
	public GetTaxOfficesResponse getTaxOffices(@WebParam(partName = "getTaxOfficesRequest", name = "getTaxOfficesRequest",
			targetNamespace = "http://www.vd.ch/fiscalite/unireg/webservices/party4") GetTaxOfficesRequest params) throws WebServiceException {
		Throwable t = null;
		int items = 0;
		final Instant start = loadMeter.start(params);
		try {
	 ...
	 * @throws ch.vd.unireg.webservices.party4.WebServiceException
