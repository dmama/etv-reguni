...
public class FunctionEqualator implements Equalator<ch.vd.evd0022.v1.Function> {

	@Override
	public boolean test(ch.vd.evd0022.v1.Function f1, ch.vd.evd0022.v1.Function f2) {
