...
public class AddCoordonneesFinancieresValidatorTest {

	private AddCoordonneesFinancieresValidator validator;
	...
	/**
	 * Ce test s'assure qu'il n'est pas possible d'ajouter des coordonnées financières avec un IBAN invalide
	 */
	@Test
