...
<table>
	...
	<tr class="<unireg:nextRowClass/>" >
		...
		<c:choose>
			...
			<c:otherwise>
                <authz:authorize access="hasAnyRole('MW_IDENT_CTB_GEST_BO', 'MW_IDENT_CTB_ADMIN', 'MW_IDENT_CTB_VISU')">
...
<table border="0">
	<tr class="<unireg:nextRowClass/>" >
		...
		<td width="25%">
            <div class="navigation-action"><input type="button" value="<fmt:message key="label.bouton.effacer"/>" name="effacer" onClick="IdentificationCtb.effacerFormulaire('${mySource}');"/></div>
		</td>
		<td width="25%">&nbsp;</td>
	</tr>
</table>
