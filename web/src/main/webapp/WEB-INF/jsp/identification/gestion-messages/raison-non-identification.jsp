...
<unireg:buttonTo name="label.bouton.retour" action="/identification/gestion-messages/edit.do" confirm="Voulez-vous vraiment quitter cette page sans sauver ?" method="get"/>
&nbsp;
