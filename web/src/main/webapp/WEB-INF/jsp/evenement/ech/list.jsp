...
<%--@elvariable id="listEvenementsEch" type="java.util.List<ch.vd.unireg.evenement.ech.view.EvenementCivilEchElementListeRechercheView>"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
    <tiles:put name="head">
  	...
  	<tiles:put name="body">
	    ...
	    <form:form method="get" id="formRechercheEvenements" modelAttribute="evenementEchCriteria">
			<fieldset>
