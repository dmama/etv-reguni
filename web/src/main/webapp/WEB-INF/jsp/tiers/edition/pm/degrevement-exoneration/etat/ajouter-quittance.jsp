...
<%--@elvariable id="ajouterQuittance" type="ch.vd.uniregctb.documentfiscal.AjouterEtatAutreDocumentFiscalView"--%>

<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	<tiles:put name="head"/>
	<tiles:put name="title">
		<fmt:message key="title.ajout.etat.ddici">
		...
		<form:form method="post" name="theForm" id="formAddEtat" action="ajouter-quittance.do" modelAttribute="ajouterQuittance">
			...
			<table border="0" style="width:35em;">
				<tr>
					...
					<td width="25%">
							<unireg:buttonTo id="annuler" name="Annuler" action="/degrevement-exoneration/edit-demande-degrevement.do" method="get" params="{id:${ajouterQuittance.id}}" />
					<td width="25%">&nbsp;</td>
				</tr>
			</table>
