...
<%--@elvariable id="addCommand" type="ch.vd.unireg.etiquette.AddEtiquetteTiersView"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<form:form id="addEtiquetteForm" modelAttribute="addCommand" action="add.do" method="post">
			...
			<table border="0">
				<tr>
					...
					<td width="25%"><unireg:buttonTo method="get" action="/etiquette/edit-list.do" params="{tiersId:${addCommand.tiersId}}" name="label.bouton.retour"/></td>
					<td width="25%">&nbsp;</td>
				</tr>
			</table>
