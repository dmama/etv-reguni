...
<%--@elvariable id="command" type="ch.vd.unireg.entreprise.EditSecteurActiviteEntrepriseView"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<form:form id="editSecteurActiviteForm" modelAttribute="command" action="edit.do">
			<fieldset>
			...
			<unireg:buttonTo method="get" action="/civil/entreprise/edit.do" params="{id:${command.tiersId}}" name="label.bouton.retour" confirm="message.confirm.quit"/>
