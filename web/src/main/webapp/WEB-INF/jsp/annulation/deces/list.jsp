...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="title">
  		<fmt:message key="title.annulation.deces.recherche.pp" />
  	</tiles:put>
	    ...
	    <form:form method="post" id="formRecherchePP" modelAttribute="AnnulationDecesCriteria">
			<fieldset>
				...
				<jsp:include page="../../tiers/recherche/form.jsp">
					<jsp:param name="typeRecherche" value="annulationDeces" />
					<jsp:param name="prefixeEffacer" value="/annulation/deces" />
				</jsp:include>
			</fieldset>
		</form:form>

		<display:table 	name="list" id="row" pagesize="25" requestURI="/annulation/deces/list.do" class="display" sort="list">
