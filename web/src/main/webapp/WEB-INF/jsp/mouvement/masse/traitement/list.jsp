...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="fichierAide">
	    <li>
		    <a href="#" onClick="ouvrirAide('<c:url value='/docs/traiter-mouvement-dossiermasse.pdf'/>');" title="AccessKey: a" accesskey="e">Aide</a>
	    </li>
	</tiles:put>
  	<tiles:put name="body">
		...
		<c:if test="${found != null}">
			<form:form method="post" action="inclure-dans-bordereau.do" modelAttribute="found">
				...
				<display:table name="found.results" id="mvt" pagesize="25" requestURI="/mouvement/masse/pour-traitement.do" class="display_table" sort="external" size="found.resultSize" partialList="true" decorator="ch.vd.unireg.decorator.TableEntityDecorator">
