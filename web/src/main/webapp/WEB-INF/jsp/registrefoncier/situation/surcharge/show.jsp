...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<unireg:linkTo name="<< Retour à la liste" action="/registrefoncier/situation/surcharge/list.do${retourParams}"/>
				...
				<table border="0">
					...
					<tr>
						...
						<td width="75%" style="padding-top: 10px">
							...
							<unireg:buttonTo name="Annuler" method="get" action="/registrefoncier/situation/surcharge/list.do${retourParams}"/>
						</td>
					</tr>
				</table>
