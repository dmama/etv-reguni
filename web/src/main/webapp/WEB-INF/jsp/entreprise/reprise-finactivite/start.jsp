...
<%--@elvariable id="actionCommand" type="ch.vd.unireg.entreprise.complexe.FinActiviteView"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<form:form method="post" id="recapFinActivite" name="recapFinActivite" commandName="actionCommand">
			...
			<input type="submit" value="<fmt:message key="label.bouton.sauver"/>" onClick="return confirm('Voulez-vous vraiment traiter la reprise partielle d\'activité de cette entreprise ?');" />
			<!-- Fin Boutons -->
