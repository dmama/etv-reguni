...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="title">
		<fmt:message key="title.transfert.patrimoine.recherche.emettrice" />
  	</tiles:put>
  	<tiles:put name="body">
	    <form:form method="post" id="formRecherche">
			<fieldset>
				...
				<jsp:include page="../../tiers/recherche/form.jsp">
					...
					<jsp:param name="prefixeEffacer" value="/processuscomplexe/transfertpatrimoine/emettrice"/>
				</jsp:include>
			</fieldset>
		</form:form>

		<display:table name="list" id="row" pagesize="25" requestURI="/processuscomplexe/transfertpatrimoine/emettrice/list.do" class="display" sort="list">
			...
			<display:column sortable="true" titleKey="label.numero.contribuable" sortProperty="numero" >
				<a href="<c:url value="/processuscomplexe/transfertpatrimoine/choix-date.do"/>?emettrice=${row.numero}"><unireg:numCTB numero="${row.numero}" /></a>
			</display:column>
