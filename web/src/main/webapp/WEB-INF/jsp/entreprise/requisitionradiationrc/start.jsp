...
<%--@elvariable id="actionCommand" type="ch.vd.unireg.entreprise.complexe.RequisitionRadiationRCView"--%>
...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
	...
	<tiles:put name="body">
		...
		<form:form method="post" id="recapReqRadiationRC" name="recapReqRadiationRC" modelAttribute="actionCommand">
