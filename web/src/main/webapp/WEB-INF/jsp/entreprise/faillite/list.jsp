...
<tiles:insert template="/WEB-INF/jsp/templates/template.jsp">
  	...
  	<tiles:put name="title">
		<fmt:message key="title.faillite.entreprise.recherche" />
  	</tiles:put>
  	<tiles:put name="body">
	    <form:form method="post" id="formRecherche">
			<fieldset>
				...
				<jsp:include page="../../tiers/recherche/form.jsp">
					...
					<jsp:param name="prefixeEffacer" value="/processuscomplexe/faillite"/>
				</jsp:include>
			</fieldset>
		</form:form>

		<display:table name="list" id="row" pagesize="25" requestURI="/processuscomplexe/faillite/list.do" class="display" sort="list">
			...
			<display:column sortable="true" titleKey="label.numero.contribuable" sortProperty="numero" >
				<a href="<c:url value="/processuscomplexe/faillite/start.do"/>?id=${row.numero}"><unireg:numCTB numero="${row.numero}" /></a>
			</display:column>
