...
public interface RetourEditiqueControllerHelper {
	...
	/**
	 * Méthode à appeler afin de gérer un objet {@link ch.vd.unireg.editique.EditiqueResultat} arrivé depuis Editique
	 ...
	 * @param onReroutageInbox action à effectuer après l'appel à la méthode {@link ch.vd.unireg.common.Flash#warning} dans le cas où le retour d'impression se fait un peu attendre et a été re-routé ver l'inbox
	...
	/**
	 * Méthode à appeler afin de gérer un objet {@link ch.vd.unireg.editique.EditiqueResultat} arrivé depuis Editique, sachant que
