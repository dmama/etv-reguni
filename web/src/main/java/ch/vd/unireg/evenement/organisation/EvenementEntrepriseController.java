...
import ch.vd.unireg.evenement.organisation.manager.EvenementEntrepriseManager;
import ch.vd.unireg.evenement.organisation.view.EvenementEntrepriseCriteriaView;
import ch.vd.unireg.evenement.organisation.view.EvenementEntrepriseDetailView;
import ch.vd.unireg.evenement.organisation.view.EvenementEntrepriseElementListeRechercheView;
import ch.vd.unireg.evenement.organisation.view.EvenementEntrepriseSummaryView;
...
public class EvenementEntrepriseController extends AbstractEvenementCivilController {
	...
	private static final String ACCESS_DENIED_MESSAGE = "Vous ne possédez aucun droit IfoSec de gestion des événements entreprise";
