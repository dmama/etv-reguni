...
import ch.vd.unireg.xml.event.taxation.pf2017.v2.DeclarationImpot;
import ch.vd.unireg.xml.event.taxation.pf2017.v2.DossierElectronique;
import ch.vd.uniregctb.evenement.retourdi.RetourDiHandler;
import ch.vd.uniregctb.jms.EsbBusinessException;

public class Pf2017V2Handler extends AbstractDossierElectroniqueHandler implements RetourDiHandler<DossierElectronique> {

	private static final Logger LOGGER = LoggerFactory.getLogger(Pf2017V2Handler.class);

	@Override
	public ClassPathResource getRequestXSD() {
		return new ClassPathResource("event/taxation/DossierElectronique-2017-2.xsd");
	}
