...
/**
 * Méthodes utilitaires pour la notification de data event
 */
abstract class DataEventNotifierHelper {

	private static final Logger LOGGER = LoggerFactory.getLogger(DataEventNotifierHelper.class);
