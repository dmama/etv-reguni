...
import ch.vd.unireg.xml.party.debtortype.v2.CommunicationMode;
import ch.vd.unireg.xml.party.v2.DebtorPeriodicityBuilder;
...
public class DebtorStrategy extends PartyStrategy<Debtor> {
	...
	protected void initBase(Debtor to, Tiers from, Context context) throws ServiceException {
		...
		to.setCategory(EnumHelper.coreToXMLv2(debiteur.getCategorieImpotSource()));
		to.setCommunicationMode(EnumHelper.coreToXMLv2(debiteur.getModeCommunication()));
