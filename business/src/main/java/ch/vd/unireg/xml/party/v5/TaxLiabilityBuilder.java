...
public abstract class TaxLiabilityBuilder {
	...
	private static Map<Class<? extends Assujettissement>, Builder<? extends Assujettissement>> buildBuilders() {
		...
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.DiplomateSuisse.class, TaxLiabilityBuilder::newSwissDiplomat);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.HorsCanton.class, TaxLiabilityBuilder::newOtherCanton);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.HorsSuisse.class, TaxLiabilityBuilder::newForeignCountry);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.Indigent.class, TaxLiabilityBuilder::newIndigent);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.SourcierMixteArt137Al1.class, TaxLiabilityBuilder::newMixedWithholding137Par1);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.SourcierMixteArt137Al2.class, TaxLiabilityBuilder::newMixedWithholding137Par2);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.SourcierPur.class, TaxLiabilityBuilder::newPureWithholding);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.VaudoisDepense.class, TaxLiabilityBuilder::newExpenditureBased);
		registerBuilder(map, ch.vd.unireg.metier.assujettissement.VaudoisOrdinaire.class, TaxLiabilityBuilder::newOrdinaryResident);
