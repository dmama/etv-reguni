...
public class PartyRequestHandlerV5 implements RequestHandlerV2<PartyRequest> {
	...
	public ClassPathResource getRequestXSD() {
		return new ClassPathResource("event/party/party-request-5.xsd");
	}

	@Override
	public List<ClassPathResource> getResponseXSD() {
		return Arrays.asList(new ClassPathResource("event/party/party-response-5.xsd"),
				new ClassPathResource("party/unireg-party-administrativeauthority-5.xsd"),
				new ClassPathResource("party/unireg-party-corporation-5.xsd"),
				new ClassPathResource("party/unireg-party-othercommunity-3.xsd"),
				new ClassPathResource("party/unireg-party-debtor-5.xsd"),
				new ClassPathResource("party/unireg-party-establishment-2.xsd"),
				new ClassPathResource("party/unireg-party-person-5.xsd"));
	}
}
