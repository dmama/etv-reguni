...
public class EvenementEntrepriseMessageCollector<T extends EvenementErreur>
		implements EvenementEntrepriseErreurCollector, EvenementEntrepriseWarningCollector, EvenementEntrepriseSuiviCollector {
	...
	public EvenementEntrepriseMessageCollector(EvenementRegistreErreurFactory<T> factory) {
