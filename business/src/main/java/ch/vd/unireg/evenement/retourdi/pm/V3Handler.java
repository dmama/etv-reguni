...
import ch.vd.unireg.xml.event.taxation.ibc.v3.AddressInformation;
import ch.vd.unireg.xml.event.taxation.ibc.v3.DeclarationIBC;
import ch.vd.unireg.xml.event.taxation.ibc.v3.DeclarationImpots;
import ch.vd.unireg.xml.event.taxation.ibc.v3.InformationMandataire;
import ch.vd.unireg.xml.event.taxation.ibc.v3.InformationPersonneMoraleModifiee;
import ch.vd.unireg.xml.event.taxation.ibc.v3.MailAddress;
import ch.vd.unireg.xml.event.taxation.ibc.v3.OrganisationMailAddressInfo;
import ch.vd.unireg.xml.event.taxation.ibc.v3.PersonMailAddressInfo;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypAdresse;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypBooleanAttr;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypDateAttr;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypNumeroIbanAttr;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypSiegeEtAdministrationEffective;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypTelephoneAttr;
import ch.vd.unireg.xml.event.taxation.ibc.v3.TypTxtMax40Attr;

@SuppressWarnings("Duplicates")
public class V3Handler extends AbstractRetourDIHandler implements RetourDiHandler<DeclarationIBC> {
	...
	public ClassPathResource getRequestXSD() {
		return new ClassPathResource("event/taxation/DeclarationIBC-3.xsd");
	}
