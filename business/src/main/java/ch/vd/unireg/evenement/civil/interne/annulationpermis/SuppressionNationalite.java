...
public abstract class SuppressionNationalite extends AnnulationPermisCOuNationaliteSuisse {
	...
	protected SuppressionNationalite(EvenementCivilRegPP evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
		super(evenement, context, options);
	}

	protected SuppressionNationalite(EvenementCivilEchFacade evenement, EvenementCivilContext context, EvenementCivilOptions options) throws EvenementCivilException {
		super(evenement, context, options);
	}
