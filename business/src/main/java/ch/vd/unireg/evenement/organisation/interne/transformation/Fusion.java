 ...
 */
public class Fusion extends EvenementEntrepriseInterneDeTraitement {

	protected Fusion(EvenementEntreprise evenement, EntrepriseCivile entrepriseCivile,
	...
	public void doHandle(EvenementEntrepriseWarningCollector warnings, EvenementEntrepriseSuiviCollector suivis) throws EvenementEntrepriseException {
		warnings.addWarning("Une vérification, pouvant aboutir à un traitement manuel (processus complexe), est requise pour cause de Fusion d'entreprises.");
