...
import ch.vd.unireg.xml.event.taxation.pf2019.v1.DeclarationImpot;
import ch.vd.unireg.xml.event.taxation.pf2019.v1.DossierElectronique;

public class Pf2019V1Handler extends AbstractDossierElectroniqueHandler implements RetourDiHandler<DossierElectronique> {

	private static final Logger LOGGER = LoggerFactory.getLogger(Pf2019V1Handler.class);

	@Override
	public ClassPathResource getRequestXSD() {
		return new ClassPathResource("event/taxation/DossierElectronique-2019-1.xsd");
	}
