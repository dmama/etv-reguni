...
public class Pf2016V2Handler extends AbstractDossierElectroniqueHandler implements RetourDiHandler<DossierElectronique> {

	private static final Logger LOGGER = LoggerFactory.getLogger(Pf2016V2Handler.class);

	@Override
	public String getRequestXSD() {
		return "event/taxation/DossierElectronique-2016-2.xsd";
	}
