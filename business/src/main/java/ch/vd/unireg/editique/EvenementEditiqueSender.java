...
public interface EvenementEditiqueSender {
	 ...
	 * @return le numéro technique du message JMS envoyé
	 */
	String envoyerDocument(String nomDocument, TypeDocumentEditique typeDocument, ch.vd.unireg.xml.editique.pp.FichierImpression document, FormatDocumentEditique typeFormat, boolean archive) throws EditiqueException;
	 ...
	 * @return le numéro technique du message JMS envoyé
	 */
	String envoyerDocumentImmediatement(String nomDocument, TypeDocumentEditique typeDocument, ch.vd.unireg.xml.editique.pp.FichierImpression document, FormatDocumentEditique typeFormat, boolean archive) throws EditiqueException;
