...
public interface EditiqueCompositionService {
	 ...
	 *
	 * @param delai le délai accordé/refusé
	 * @param dateExpedition date d'expédition de la lettre
	 * @return idDocument, la clé d'archivage du document
	 * @throws EditiqueException en cas de souci
	 */
	Pair<String, String> imprimeLettreDecisionDelaiQSNCBatch(DelaiDeclaration delai, RegDate dateExpedition) throws EditiqueException;
	 ...
	 * @throws EditiqueException
	 */
	EditiqueResultat imprimeDuplicataLettreBienvenueOnline(LettreBienvenue lettre, RegDate dateTraitement) throws EditiqueException;
	 ...
	 * @throws EditiqueException en cas de problème
	 */
	void imprimeRappelFormulaireDemandeDegrevementICIForBatch(DemandeDegrevementICI formulaire, RegDate dateTraitement) throws EditiqueException;
