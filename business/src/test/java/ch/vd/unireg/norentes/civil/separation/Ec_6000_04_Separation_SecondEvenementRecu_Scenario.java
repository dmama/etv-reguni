...
public class Ec_6000_04_Separation_SecondEvenementRecu_Scenario extends EvenementCivilScenario {
	...
	/**
	 * @see ch.vd.unireg.norentes.common.NorentesScenario#getDescription()
	 */
	@Override
	...
	/**
	 * @see ch.vd.unireg.norentes.common.NorentesScenario#getName()
	 */
	@Override
	...
	/**
	 * @see ch.vd.unireg.norentes.common.NorentesScenario#geTypeEvenementCivil()
	 */
	@Override
