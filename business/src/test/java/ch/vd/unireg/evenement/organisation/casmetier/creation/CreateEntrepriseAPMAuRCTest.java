 ...
 */
public class CreateEntrepriseAPMAuRCTest extends AbstractEvenementOrganisationProcessorTest {
	...
	public void testCreationAPMNonRC() throws Exception {
		...
		doInNewTransactionAndSession(new TransactionCallback<Object>() {
			                             ...
			                             public Object doInTransaction(TransactionStatus status) {
				                             ...
				                             Assert.assertEquals(String.format("Pas de création automatique de l'association/fondation n°%d [Association bidule] non inscrite au RC (risque de création de doublon). Veuillez vérifier et le cas échéant créer le tiers associé à la main.", noOrganisation)
