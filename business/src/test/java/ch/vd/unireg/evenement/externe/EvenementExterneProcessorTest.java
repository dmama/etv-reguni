...
public class EvenementExterneProcessorTest extends BusinessTest {
	...
	public void testRelanceAnnulationQuittancementSansRetourPrealable() throws Exception {
		...
		doInNewTransactionAndSession(status -> {
			...
			final String erreurAttendue =
					String.format("La déclaration impôt source sélectionnée (tiers=%d, période=%s) ne contient pas de retour à annuler.", ids.dpiId, DateRangeHelper.toDisplayString(new DateRangeHelper.Range(dateDebut, dateFin)));
