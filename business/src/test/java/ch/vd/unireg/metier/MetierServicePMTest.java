...
public class MetierServicePMTest extends BusinessTest {
	...
	public void testRattacheEntreprisesCivileEtFiscalAvecSecondaires() throws Exception {
		...
		final Ids ids = doInNewTransactionAndSession(status -> {
			...
			ids1.entrepriseId = entreprise.getNumero();
			ids1.etablissement3Id = etablissement3.getNumero();
			return ids1;
		});
	...
	public void testFusionEntreprises() throws Exception {
		...
		final Ids ids = doInNewTransactionAndSession(status -> {
			...
			final Ids ids1 = new Ids();
			ids1.idAbsorbante = absorbante.getNumero();
			ids1.idEtablissementPrincipalAbsorbante = etablissementPrincipalAbsorbante.getNumero();
			ids1.idAbsorbee1 = absorbee1.getNumero();
			ids1.idEtablissementPrincipalAbsorbee1 = etablissementPrincipalAbsorbee1.getNumero();
			ids1.idAbsorbee2 = absorbee2.getNumero();
			ids1.idEtablissementPrincipalAbsorbee2 = etablissementPrincipalAbsorbee2.getNumero();
			return ids1;
		});
	...
	public void testScissionEntreprise() throws Exception {
		...
		final Ids ids = doInNewTransactionAndSession(status -> {
			...
			final Ids ids1 = new Ids();
			ids1.idScindee = scindee.getNumero();
			ids1.idEtablissementPrincipalScindee = etablissementPrincipalScindee.getNumero();
			ids1.idResultante1 = resultante1.getNumero();
			ids1.idEtablissementPrincipalResultante1 = etablissementPrincipalResultante1.getNumero();
			ids1.idResultante2 = resultante2.getNumero();
			ids1.idEtablissementPrincipalResultante2 = etablissementPrincipalResultante2.getNumero();
			return ids1;
		});
	...
	public void testTransfertPatrimoine() throws Exception {
		...
		final Ids ids = doInNewTransactionAndSession(status -> {
			...
			final Ids ids1 = new Ids();
			ids1.idEmettrice = emettrice.getNumero();
			ids1.idEtablissementPrincipalEmettrice = etablissementPrincipalEmettrice.getNumero();
			ids1.idReceptrice1 = receptrice1.getNumero();
			ids1.idEtablissementPrincipalReceptrice1 = etablissementPrincipalReceptrice1.getNumero();
			ids1.idReceptrice2 = receptrice2.getNumero();
			ids1.idEtablissementPrincipalReceptrice2 = etablissementPrincipalReceptrice2.getNumero();
			return ids1;
		});
