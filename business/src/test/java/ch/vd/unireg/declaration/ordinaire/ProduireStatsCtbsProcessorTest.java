...
public class ProduireStatsCtbsProcessorTest extends BusinessTest {
	...
	protected void runOnSetUp() throws Exception {
		...
		processor = new ProduireStatsCtbsProcessor(hibernateTemplate, serviceInfra, tiersService, transactionManager, assujettissementService, periodeImpositionService, adresseService);
	}
