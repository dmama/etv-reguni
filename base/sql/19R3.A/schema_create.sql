...
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('19R1.C', 'create');
...
CREATE TABLE EVENEMENT_FISCAL (
	...
	TYPE_EVT_COMMUNAUTE NVARCHAR2(20),
	...
	COMMUNAUTE_ID NUMBER(19)
		constraint FK_EVTFISC_COMMUNAUTE_ID
...
create table PARAMETRE_PERIODE_FISCALE (PPF_TYPE nvarchar2(5) not null, id number(19,0) not null, ANNULATION_DATE timestamp, ANNULATION_USER nvarchar2(65), LOG_CDATE timestamp, LOG_CUSER nvarchar2(65), LOG_MDATE timestamp, LOG_MUSER nvarchar2(65), DATE_FIN_ENVOI_MASSE number(10,0), TERME_GEN_SOMM_EFFECT number(10,0), TERME_GEN_SOMM_REGL number(10,0), TYPE_CTB nvarchar2(17), PERIODE_ID number(19,0) not null, PM_DELAI_IMPRIME_MOIS NUMBER(10,0), PM_TOLERANCE_JOURS NUMBER(10,0), PM_DELAI_IMPRIME_FIN_MOIS NUMBER(1,0), PM_TOLERANCE_FIN_MOIS NUMBER(1,0), PM_REF_DELAI NVARCHAR2(12), SNC_RAPPEL_IMPRIME NUMBER(10,0), SNC_RAPPEL_EFFECTIF NUMBER(10,0), EMOL_TYPE_DOCUMENT NVARCHAR2(15), EMOL_MONTANT NUMBER(8,0), TYPE_TIERS NVARCHAR2(2), primary key (id));
...
(
	...
	LOG_MDATE TIMESTAMP(6),
	LOG_MUSER NVARCHAR2(65),
	MASTER_ID_RF NVARCHAR2(37) NOT NULL
);
...
(
	...
	MASTER_ID_RF NVARCHAR2(37) NOT NULL,
	VERSION_ID_RF NVARCHAR2(37) NOT NULL,
...
CREATE INDEX IDX_SIT_RF_COMMUNE_ID ON RF_SITUATION (COMMUNE_ID);
