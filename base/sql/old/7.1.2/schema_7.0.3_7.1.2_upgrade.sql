-- Version
INSERT INTO VERSION_DB (VERSION_NB, SCRIPT_ID) VALUES ('7.1.2', '7.0.3_7.1.2_upgrade');
...
-- [SIFISC-24484] Rattrapage des tâches dont la catégorie d'entreprise a disparu
UPDATE TACHE SET CATEGORIE_ENTREPRISE='PM' WHERE CATEGORIE_ENTREPRISE='DPPM';
UPDATE TACHE SET CATEGORIE_ENTREPRISE='APM' WHERE CATEGORIE_ENTREPRISE IN ('FP', 'DPAPM');