...
UPDATE ETAT_DECLARATION SET DATE_ENVOI_COURRIER = DATE_OBTENTION WHERE TYPE = 'SOMME';

UPDATE ETAT_DECLARATION SET DATE_OBTENTION = TO_CHAR(LOG_CDATE, 'YYYYMMDD')  WHERE TYPE = 'SOMME';
